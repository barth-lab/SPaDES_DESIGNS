...
option.add( basic::options::OptionKeys::in::fconfig, "A list of flag configurations to look for.  These can be in either your working directory or $HOME/.rosetta/flags directory.  Ex: -fconfig common design" ).def("common");
option.add( basic::options::OptionKeys::in::no_fconfig, "Do not load the [common] config file if present. " ).def(false);
option.add( basic::options::OptionKeys::in::skip_classic_cart_setup, "No description" ).def(false);
option.add( basic::options::OptionKeys::in::skip_new_cart_setup, "No description" ).def(false);
...
option.add( basic::options::OptionKeys::in::ignore_waters, "Ignore HOH residues found in PDB file. Note: HOH residues, and waters in general, are incompatible with the default solvation model (LK).  Make sure to use -beta instead." ).def(true);
option.add( basic::options::OptionKeys::in::water_type_if_unspecified, "The name of the water residue type to use if the specific water type is not specified in the input file." ).def("");
...
option.add( basic::options::OptionKeys::in::read_only_ATOM_entries, "Sets whether to ignore everything except ATOM entries." ).def(false);
option.add( basic::options::OptionKeys::in::auto_detect_glycan_connections, "Sets whether to search for non-protein connections using PDB coordinates and generate LINK records." ).shortd( "Generate missing LINK records." ).legal(true).legal(false).def(false);
option.add( basic::options::OptionKeys::in::max_bond_length, "Sets maximum O-C distance for glycan connection search. Default is 1.65 Angstroms." ).shortd( "Max distance for glycan C-O bond" ).def(1.65);
option.add( basic::options::OptionKeys::in::min_bond_length, "Sets minimum O-C distance for glycan connection search. Default is 1.15 Angstroms." ).shortd( "Min. distance for glycan C-O bond" ).def(1.15);
option.add( basic::options::OptionKeys::in::glycan_virtual_offset, "Apply a very small offset to the glycan virtual positions to avoid collinearity in the angle minimization." ).shortd( "Glycan virtual offset" ).def(0);
...
option.add( basic::options::OptionKeys::in::tuning_param, "Specify the tuning parameter to modulate lowres and highres score functions." ).def(1.0);
...
option.add( basic::options::OptionKeys::in::obey_ssbond, "When true, defer to the SSBOND records in the PDB for disulfide specification.When false, use -detect_disulf settings to determine disulfide bonding." ).def(false);
...
option.add( basic::options::OptionKeys::in::path::bcl, "Path to the BCL submodule in Rosetta. Must lead to a valid BCL submodule. If the BCL is not found then we attempt to resolve the path relative to the Rosetta database." );
...
option.add( basic::options::OptionKeys::in::file::srlz, "input serialized poses (as opposed to PDB files)" ).def(false);
option.add( basic::options::OptionKeys::in::file::srlz_override, "identical to in:file:srlz except this does not terminate if the input file was generated by a different version of Rosetta." ).def(false);
...
option.add( basic::options::OptionKeys::in::file::no_detect_pseudobonds, "By default, Rosetta automatically detects pseudobonds on file import.  If this is set to true, this auto-detection is disabled.  False by default." ).def(false);
...
option.add( basic::options::OptionKeys::in::file::extra_res, ".params file(s) for new residue types (e.g. ligands)" ).def();
option.add( basic::options::OptionKeys::in::file::extra_res_fa, ".params file(s) for new fullatom residue types (e.g. ligands)" ).def();
option.add( basic::options::OptionKeys::in::file::override_database_params, "Use input .params file(s) instead of database if residue name is found in residue set" ).def(false);
option.add( basic::options::OptionKeys::in::file::extra_res_mol, ".mol file(s) for new fullatom residue types (e.g. ligands)" ).def();
option.add( basic::options::OptionKeys::in::file::extra_res_mmCIF, ".mmCIF file(s) for component dictionary for residue types (e.g. ligands)" ).def();
option.add( basic::options::OptionKeys::in::file::load_PDB_components, "Use the PDB ligand definitions to load all standard residue descriptions." ).def(true);
option.add( basic::options::OptionKeys::in::file::PDB_components_directory, "The directory storing a collection of Chemical Components Dictionary mmCIF-formatted files, named as 'components.?.cif'" ).def("chemical/pdb_components");
option.add( basic::options::OptionKeys::in::file::PDB_components_overrides, "Any supplementary CIF file from which to load the PDB component definitions. These take first priority and can be used to correct the directory." ).def();
option.add( basic::options::OptionKeys::in::file::check_all_PDB_components, "When set false, ignore PDB components with a name3 matching a Rosetta database type, even if they're chemically different." ).def(true);
...
option.add( basic::options::OptionKeys::in::file::extra_res_cen, ".params file(s) for new centroid residue types (e.g. ligands)" ).def();
option.add( basic::options::OptionKeys::in::file::extra_res_path, "directories with .params files.  Only files containing 'param' will be chosen" ).def();
option.add( basic::options::OptionKeys::in::file::extra_rot_lib_path, "directories with NCAA rotamer files." ).def();
option.add( basic::options::OptionKeys::in::file::override_rot_lib_path, "if rotamer libraries are found in this directory, prioritize them and not others" ).def();
option.add( basic::options::OptionKeys::in::file::extra_res_batch_path, "directories generated by src/python/apps/public/batch_molfile_to_params.py.  Only files containing 'param' will be chosen" ).def();
option.add( basic::options::OptionKeys::in::file::extra_patch_fa, "patch files for full atom variants not specified in the database" ).def();
option.add( basic::options::OptionKeys::in::file::extra_patch_cen, "patch files for centroid atom variants not specified in the database" ).def();
...
option.add( basic::options::OptionKeys::in::file::hrf_ms_labeling, "Experimental Mass Spec HRF labeling data" );
...
option.add( basic::options::OptionKeys::inout::mmtf_extra_data_io, "If reading/writing mmTF, read/write extra data including pdb_comments, extra scores, and SimpleMetrics?" ).def(true);
option.add( basic::options::OptionKeys::inout::output_alternate_atomids, "Use the alternate atom IDS as stored in the params files when available" ).def(false);
...
option.add( basic::options::OptionKeys::out::mover_controlled_output_name, "allows the mover to control the output name" ).def(false);
...
option.add( basic::options::OptionKeys::out::mmtf, "output mmtf files (broadly, as opposed to PDB files)" ).def(false);
option.add( basic::options::OptionKeys::out::mmtf_gz, "if outputting mmtf files, gzip them" ).def(false);
...
option.add( basic::options::OptionKeys::out::no_color, "Suppress use of tracer color codes, which can appear as '^[[0m' in log files" ).def(false);
...
option.add( basic::options::OptionKeys::out::file::srlz, "output serialized poses (as opposed to PDB files)" ).def(false);
...
option.add( basic::options::OptionKeys::out::file::output_ligands_as_separate_chains, "Set whether or not ligands are output with unique chainIDs, even if they share a chainID with one of the peptide chains in the input structure.  The default value is false." ).shortd( "Reassign ligand chainIDs?" ).legal(true).legal(false).def(false);
...
option.add( basic::options::OptionKeys::out::file::use_occurrence_data, "if option is true reads probability matrix from pssm file." ).def(false);
...
option.add( basic::options::OptionKeys::out::file::set_pdb_author, "Set the author name(s), if any, to output in the .pdb Title Section. List of names should be comma-delimited." ).shortd( "AUTHOR?" ).def("");
option.add( basic::options::OptionKeys::out::file::write_pdb_title_section_records, "Sets whether or not the title section records in PDB files are written.  The title section includes HEADER, EXPDTA, AUTHOR, and REMARK records.  The default value is true." ).shortd( "Write HEADER, EXPDTA, AUTHOR, and REMARK records?" ).legal(true).legal(false).def(true);
option.add( basic::options::OptionKeys::out::file::write_pdb_link_records, "Sets whether or not the LINK records in PDB files are written.  The default value is true." ).shortd( "Write LINK records?" ).legal(true).legal(false).def(true);
...
option.add( basic::options::OptionKeys::out::file::write_glycan_pdb_codes, "If true glycans will be written based on the pdb codes rather than the rosetta names" ).shortd( "Use PDB codes for glycan residues" ).legal(true).legal(false).def(false);
option.add( basic::options::OptionKeys::out::file::write_seqres_records, "Sets whether or not the SEQRES records in PDB files are written. The default value is false." ).shortd( "Write SEQRES records?" ).legal(true).legal(false).def(false);
...
option.add( basic::options::OptionKeys::out::file::output_only_asymmetric_unit, "For symmetrical poses, de-symmetrize the pose before output in order to output only the master subunit.  Energies will still be output as symmetrical. Does not work with Silent files." ).def(false);
option.add( basic::options::OptionKeys::out::file::cif_extra_data_separate_file, "When outputting mmCIF, write extra data and energies to separate files (JOBNAME.extradata and JOBNAME.eneriges)" ).def(false);
...
option.add( basic::options::OptionKeys::out::path::mmtf, "mmtf file output path" );

}
inline void add_rosetta_options_1( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::run::run, "Run option group" ).legal(true).def(true).is_group(true);
...
option.add( basic::options::OptionKeys::run::version, "write out detailed version info, if it was available at compile time" ).def(false);
...
option.add( basic::options::OptionKeys::run::preserve_header, "Maintain header info from input PDB when writing output PDBs" ).def(false);
...
option.add( basic::options::OptionKeys::run::nosignal, "Don't install the signal handler to catch segfaults, etc. in the crash reporter. Useful for running under a debugger." ).def(false);
option.add( basic::options::OptionKeys::run::crash_to_console, "Show the backtrace on the console/tracer in addition to the crash report file." ).def(false);
...
option.add( basic::options::OptionKeys::run::PyMOLMover::PyMOLMover, "PyMOLMover option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::run::PyMOLMover::address, "TCP port address to use when initializing PyMOLMover" ).def("");
option.add( basic::options::OptionKeys::run::PyMOLMover::port, "TCP port to use when initializing PyMOLMover" ).def(0);
option.add( basic::options::OptionKeys::run::PyMOLMover::max_packet_size, "Max size of packet to send to PyMOL. Default value is dependable from address: for 127.0.0.1 it will be set to 7678 and any other addresses to 1500." ).def(0);
option.add( basic::options::OptionKeys::parser::parser, "parser option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::parser::protocol, "The protocol you will be running. (Input XML File" );
...
option.add( basic::options::OptionKeys::parser::never_rerun_filters, "Interpret all <Add filter=foo/> elements as <Add filter=foo never_rerun_filter=true/> in rosetta_scripts. Filters are run only once at apply time." ).def(false);
...
option.add( basic::options::OptionKeys::parser::inclusion_recursion_limit, "How many recursions to perform when parsing an XML file with inclusions" ).def(8);
...
option.add( basic::options::OptionKeys::jd3::do_not_archive_on_node0, "Should the master node in the MPIWorkPoolJobDistributor archive any JobResults on it? Only relevant for MPI builds when using -n_archive_nodes" ).def(false);
option.add( basic::options::OptionKeys::jd3::mpi_fraction_outputters, "Fraction of the MPI nodes that node0 is allowed to use to output job results; non-archive nodes that output will also perform regular work in addition to their output work. This flag should range from 0 to 1. Note that node0 never outputs, so even if this is set to 0, one node will be deputized as an output node." ).def(0.01);
option.add( basic::options::OptionKeys::jd3::nthreads, "For the multithreaded job distributor, how many threads should be run at the same time" );
option.add( basic::options::OptionKeys::jd3::archive_on_disk, "Sometimes job results use a ton of memory. This option tells Rosetta to store job results on disk instead of in memory. The string you pass here should be the name of a (preferably empty) directoy where we can put all of our temporary files. You can delete this directory and everything in it when Rosetta is done running." ).def("null");
option.add( basic::options::OptionKeys::jd3::compress_job_results, "Sometimes job results use a ton of memory. This option tells Rosetta to compress all job results so they use less memory." ).def(true);
option.add( basic::options::OptionKeys::jd3::resource_definition_files, "Specify all the resources to available for the jobs running." );
option.add( basic::options::OptionKeys::jd3::resource_definition_schema, "If provided on the command line, the job distributor will write the XML Schema for the applciation's resource definition file out to disk and then exit" );
option.add( basic::options::OptionKeys::jd3::load_input_poses_only_once, "If the same Pose is used as input to multiple jobs (which can only happen when a job definition file is provided, but the input poses come from the command line), then preserve those input poses in memory until they will not be used in any future jobs. This necessarily comes with an increased memory footprint and is likely undesireable if the number of jobs is large!" );
option.add( basic::options::OptionKeys::jd3::checkpoint, "Should we checkpoint job progress? Uses default values for checkpoint_period and checkpoint_directory" );
option.add( basic::options::OptionKeys::jd3::checkpoint_period, "The approximate number of minutes between checkpoints. If this flag is provided by the user, then checkpointing will occurr, even if the -checkpoint flag is not on the command line." ).def(30);
option.add( basic::options::OptionKeys::jd3::checkpoint_directory, "What directory should checkpoints be written to? If this flag is provided by the user, then checkpointing will occurr, even if the -checkpoint flag is not on the command line." ).def("checkpoints");
option.add( basic::options::OptionKeys::jd3::restore_from_checkpoint, "Should the contents of the checkpoint directory be used to restart a previously run job that was interrupted before it could be completed? If this flag is not present on the command line when trying to rerun a previously-run but interrupted job, then Rosetta will not attempt to restore the job from the checkpoint file. This is to safeguard against accidentally restoring from a checkpoint generated by some other execution of the code." );
option.add( basic::options::OptionKeys::jd3::continue_past_failed_checkpoint_restoration, "Should we keep going even if we could not restore from a checkpoint as requested? Use this if you are ok with possibly of starting over from the beginning, or if you expect to relaunch the job multiple times and want simply to use the same command line each time, including the first time you launch the job and there are no checkpoints yet to restore from." );
option.add( basic::options::OptionKeys::jd3::keep_all_checkpoints, "Allow old checkpoint files to build up on disk. Cannot be combined with -archive_on_disk. Using this flag could use up a lot of disk space unncessarily. If this flag is not present on the command line, then previously created checkpoints will be deleted when the next checkpoints are created. Note that job distributor will delete the previous checkpoint by default after the next checkpoint is written to disk." );
option.add( basic::options::OptionKeys::jd3::keep_checkpoint, "Prevent the JobDistributor from deleting a particular checkpoint; perhaps useful if you are trying to debug an infrequent event and you want to restart from a particular checkpoint repeatedly without worrying that the JobDistributor will delete your starting point." );
option.add( basic::options::OptionKeys::jd3::job_definition_script_vars, "Variable substitutions for xml parser, in the form of name=value" );
...
option.add( basic::options::OptionKeys::jd2::input_empty_pose, "Give the job distributor an empty pose." ).def(false);
option.add( basic::options::OptionKeys::jd2::dd_parser, "determine whether to use the dock_design_parser" ).def(false);
option.add( basic::options::OptionKeys::jd2::ntrials, "number of attempts at creating an output file for each nstruct. e.g., ntrials 3 and nstruct 10 would mean that each of 10 trajectories would attempt to write an output file 3 times and if unsuccessful would fail." ).def(1);
...
option.add( basic::options::OptionKeys::jd2::delete_old_poses, "Delete poses after they have been processed.  For jobs that process a large number of structures, the memory consumed by old poses is wasteful.  True by default, since there is no good reason to effectively leak memory." ).def(true);
...
option.add( basic::options::OptionKeys::jd2::HOSTNAME_in_jobname, "Pre-prefixes job with $HOSTNAME env var; useful for determining which server a job came from.  When running in k8s pods, makes jobs distinct if they are all _0001" );
option.add( basic::options::OptionKeys::jd2::parse_script_once_only, "Skip reparsing the xml for every input and use the movers as they are? Some movers may not work correctly with this enabled." ).def(false);
option.add( basic::options::OptionKeys::view::view, "view option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::view::show_virtual_residues, "Show virtual residues?" ).def(true);
option.add( basic::options::OptionKeys::view::single_glycan_color, "Show glycans as a single color instead of default" ).def(true);
...
option.add( basic::options::OptionKeys::score::lowres_weights, "Name of lowres weights file (without extension .wts)" ).def("interchain_cen");
option.add( basic::options::OptionKeys::score::weights, "Name of weights file (without extension .wts)" ).def("ref2015");
...
option.add( basic::options::OptionKeys::score::pack_weights, "Name of packing weights file (without extension .wts)" ).def("ref2015");
...
option.add( basic::options::OptionKeys::score::fa_Hatr, "Turn on Lennard Jones attractive term for hydrogen atoms" ).def(true);
option.add( basic::options::OptionKeys::score::no_smooth_etables, "Revert to old style etables" );
option.add( basic::options::OptionKeys::score::count_pair_hybrid, "Use standard count-pair for non-ligands and cp3 w/ full-weight 1-4 for ligands" ).def(false);
option.add( basic::options::OptionKeys::score::count_pair_full, "Use cp3 w/ full-weight 1-4 for everything" ).def(false);
...
option.add( basic::options::OptionKeys::score::fa_stack_include_rna_protein, "Calculate fa_stack for RNA/protein" ).def(true);
...
option.add( basic::options::OptionKeys::score::hb_max_energy, "Max possible hbond energy. Under nearly all circumstances this should be set to 0.0." ).def(0.0);
option.add( basic::options::OptionKeys::score::hbond_params, "Directory name in the database for which hydrogen bond parameters to use." ).def("ref2015_params");
...
option.add( basic::options::OptionKeys::score::use_hb_env_dep, "Use hydrogen bond environment dependency. Smaller in the surface of the protein." ).def(true);
option.add( basic::options::OptionKeys::score::water_hybrid_sf, "Use a hybrid scoring function, which includes energy terms hbond_wat and wat_entropy." ).def(false);
option.add( basic::options::OptionKeys::score::show_etable_contributions, "Shows atom-atom and res-res contributions to Lennard-Jones and solvation energies when scoring." ).def(false);
...
option.add( basic::options::OptionKeys::score::extra_mm_params_dir, "Directory/ies with extra parameter files for the mm score terms. (Looks for mm_torsion_params.txt, mm_bond_angle_params.txt and mm_bond_length_params.txt)" ).def();
option.add( basic::options::OptionKeys::score::gen_bonded_params_file, "Parameters for [length,angle,torsion,improper-torsion]" ).def("scoring/score_functions/generic_potential/generic_bonded.round6p.txt");
option.add( basic::options::OptionKeys::score::torsion_distr_params_file, "Parameters for gaussian functions of torsion distributions" ).def("scoring/score_functions/generic_potential/torsion_distribution.round6p.gz.v1.txt");
option.add( basic::options::OptionKeys::score::gen_bonded_exclude_def_file, "Definitions for double-counting params with other energy terms" ).def("scoring/score_functions/generic_potential/params_exclude.txt");
option.add( basic::options::OptionKeys::score::genbonded_score_full, "Turn on gen_bonded term for all residue types (e.g. canonical amino acids)" ).def(false);
option.add( basic::options::OptionKeys::score::genbonded_score_hybrid, "Turn on gen_bonded term only for parts missing (e.g. ligands, torsions not covered by rama/fa_dun, ...)" ).def(false);
option.add( basic::options::OptionKeys::score::extra_improper_file, "Add extra parameters for improper torsions" );
option.add( basic::options::OptionKeys::score::cart_bonded_skip_cutpoints, "skip cart_bonded evaluation if res1-2 are defined as cutpoint" ).def(true);
...
option.add( basic::options::OptionKeys::score::unmodifypot, "Do not call modify pot to add extra repulsive interactions between Obb/Obb atom types at distances beneath 3.6 Angstroms" ).def(true);
...
option.add( basic::options::OptionKeys::score::approximate_buried_unsat_penalty_hbond_energy_threshold, "Energy threshold for a h-bond to be considered satisfying a buried polar. Should be a negative number. (Setting to -0.001 will be much faster than 0 at runtime)" ).def(-0.25);
option.add( basic::options::OptionKeys::score::approximate_buried_unsat_penalty_burial_atomic_depth, "The atomic depth cutoff to determine whether or not a polar atom is buried. Measured from the Sasa surface." ).def(4.5f);
option.add( basic::options::OptionKeys::score::approximate_buried_unsat_penalty_burial_probe_radius, "The probe radius for the atomic depth calculation." ).def(2.3f);
option.add( basic::options::OptionKeys::score::approximate_buried_unsat_penalty_burial_resolution, "The resolution for the atomic depth calculation." ).def(0.5f);
option.add( basic::options::OptionKeys::score::approximate_buried_unsat_penalty_oversat_penalty, "The penalty between atoms that both satisfy the same atom. If we let X = weight_of_approximate_buried_unsat_penalty. Then in general, a buried unsat is worth X, a satisfied unsat is worth 0, a doubly satisfied unsat is worth X * ( setting-1.0 ), a triply satisfied unsat is worth X * ( -2 + 3 * setting ), a N-ly satisfied unsat is worth X * ( 1 - N + 0.5 * N * (N - 1) )." ).def(1.0);
option.add( basic::options::OptionKeys::score::approximate_buried_unsat_penalty_assume_const_backbone, "Should we assume that the backbone atoms will not change during a packing trajectory? (i.e. no positions that include normal aa and proline or n-methyl) If set to false, this energy method takes longer to compute. (~ 2X as long)" ).def(true);
option.add( basic::options::OptionKeys::score::approximate_buried_unsat_penalty_natural_corrections1, "Apply the following corrections to buried unsat penalty: nh2_wants_2, nh1_wants_1, hydroxyl_wants_h, carboxyl_wants_2" ).def(false);
option.add( basic::options::OptionKeys::score::approximate_buried_unsat_penalty_hbond_bonus_cross_chain, "Apply a bonus factor to hydrogen bonds accross chains. Remember to set this negative." ).def(0);
option.add( basic::options::OptionKeys::score::approximate_buried_unsat_penalty_hbond_bonus_ser_to_helix_bb, "Apply a bonus factor to the classic SER/THR i - i-4 h-bond. OG/OG1 - O. Set this positive to penalize." ).def(0);
option.add( basic::options::OptionKeys::score::approximate_buried_unsat_penalty_lys_ok_with_1, "Make LYS N work like carbonyl O where it prefers 1 or 2 h-bonds." ).def(false);
option.add( basic::options::OptionKeys::score::target_clash_pdb, "The target pdb file for clashing check with the target_clash score term." ).def("");
...
option.add( basic::options::OptionKeys::score::buried_unsatisfied_penalty_cone_angle_exponent, "The angle exponent for calculating burial by the method of sidechain neighbor cones, used by the BuriedUnsatPenalty energy." ).def(2.0);
option.add( basic::options::OptionKeys::score::buried_unsatisfied_penalty_cone_angle_shift_factor, "The angle shift factor for calculating burial by the method of sidechain neighbor cones, used by the BuriedUnsatPenalty energy." ).def(0.25);
option.add( basic::options::OptionKeys::score::buried_unsatisfied_penalty_cone_dist_exponent, "The distance exponent for calculating burial by the method of sidechain neighbor cones, used by the BuriedUnsatPenalty energy." ).def(1.0);
option.add( basic::options::OptionKeys::score::buried_unsatisfied_penalty_cone_dist_midpoint, "The distance midpoint for calculating burial by the method of sidechain neighbor cones, used by the BuriedUnsatPenalty energy." ).def(9.0);
option.add( basic::options::OptionKeys::score::buried_unsatisfied_penalty_burial_threshold, "The number of cones in which a point must lie to be considered buried by the method of sidechain neighbor cones, used by the BuriedUnsatPenalty energy." ).def(5.0);
option.add( basic::options::OptionKeys::score::buried_unsatisfied_penalty_hbond_energy_threshold, "The energy threshold above which a hydrogen bond is not counted, used by the BuriedUnsatPenalty energy." ).def(-0.25);
option.add( basic::options::OptionKeys::score::covalent_labeling_input, "Input covalent labeling data in the form of neighbor counts" );
option.add( basic::options::OptionKeys::score::hrf_dynamics_input, "Input covalent labeling data in the form of protection factors for FA" );
option.add( basic::options::OptionKeys::score::covalent_labeling_fa_input, "Input covalent labeling data in the form of neighbor counts for FA" );
option.add( basic::options::OptionKeys::score::depc_ms_input, "Input DEPC covalent labeling MS data in the form of His/Lys/Ser/Thr/Tyr residue numbers and labeling status of labeled (L) or unlabeled (U)" );
...
option.add( basic::options::OptionKeys::score::elec_sigmoidal_die, "changes the dielectric from distance dependent to sigmoidal" ).def(true);
option.add( basic::options::OptionKeys::score::elec_sigmoidal_die_D, "D parameter for sigmoidal dielectric" ).def(80.0);
option.add( basic::options::OptionKeys::score::elec_sigmoidal_die_D0, "D0 parameter for sigmoidal dielectric" ).def(6.0);
option.add( basic::options::OptionKeys::score::elec_sigmoidal_die_S, "S parameter for sigmoidal dielectric" ).def(0.4);
option.add( basic::options::OptionKeys::score::stack_elec_sigmoidal_die, "override of -elec_sigmoidal_die for stack_elec" ).def(false);
option.add( basic::options::OptionKeys::score::elec_representative_cp, "Use representative atoms for countpair to avoid dipole splits" ).def(true);
option.add( basic::options::OptionKeys::score::elec_representative_cp_flip, "Enable elec_representative_cp, but FLIP the order in the table" ).def(true);
...
option.add( basic::options::OptionKeys::score::hbnet_bonus_function_ramping, "The hbnet score term's bonus function can scale in different ways as the size of a network grows.  The default is quadratic growth, though linear, logarithmic, and square root growth are all allowed." ).legal("quadratic").legal("linear").legal("logarithmic").legal("squareroot").def("quadratic");
option.add( basic::options::OptionKeys::score::hbnet_max_network_size, "This is the maximum hydrogen bond network size, beyond which the hbnet score term will not give any more bonus.  Defaults to 0, which means no limit." ).def(0);
...
inline void add_rosetta_options_2( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::score::facts_dshift, "FACTS pair term denominator distance shift[bb/bbsc/scsc/saltbridge]" ).def(0.0).def(1.5).def(1.5).def(1.5);
...
option.add( basic::options::OptionKeys::score::netcharge_setup_file, "The filename of one or more setup files for the netcharge scoring term.  (Multiple such files can be listed, separated by a space.)  The default location for these files (which have a .charge extension) is /database/scoring/score_functions/netcharge/." );
option.add( basic::options::OptionKeys::score::mhc_epitope_setup_file, "The filename of one or more setup files for the mhc_epitope scoring term.  (Multiple such files can be listed, separated by a space.)  The default location for these files (which have a .mhc extension) is /database/scoring/score_functions/mhc_epitope/." );
option.add( basic::options::OptionKeys::score::ms_dist_midpoint, "distance midpoint for distance factor for HRF_MSLabeling score term" ).def(9.0);
option.add( basic::options::OptionKeys::score::ms_dist_exponent, "distance exponent for distance factor for HRF_MSLabeling score term" ).def(0.1);
option.add( basic::options::OptionKeys::score::ms_fit_slope, "slope for burial measure calc from lnPF for HRF_MSlabeling score term" ).def(3.827);
option.add( basic::options::OptionKeys::score::ms_fit_intercept, "intercept for burial measure calc from lnPF for HRF_MSlabeling score term" ).def(36.202);
option.add( basic::options::OptionKeys::score::ms_fade_outer, "outer limit for FadeFunc in HRF_MSLabeling score term" ).def(10.0);
option.add( basic::options::OptionKeys::score::ms_fade_dist, "fade distance for FadeFunc in HRF_MSLabeling score term" ).def(5.0);
option.add( basic::options::OptionKeys::score::ccs_exp, "Experimental CCS Data, in squared Angstroms, from IMMS for CCS_IMMSEnergy score term, this is a required input from the user" );
option.add( basic::options::OptionKeys::score::ccs_prad, "Radius of probe, in Angstroms, for CCS calculation for CCS_IMMSEnergy score term, by default 1.0 Angstrom is used to predict CCS in helium buffer gas conditions" ).def(1.0);
option.add( basic::options::OptionKeys::score::ccs_nrots, "Number of random rotations, must be integers, for CCS calculation for CCS_IMMSEnergy score term" ).def(300);
...
option.add( basic::options::OptionKeys::score::nmer_svm, "nmer svm filename (libsvm)" ).def("");
option.add( basic::options::OptionKeys::score::nmer_svm_list, "list of nmer svm filenames (libsvm)" ).def("");
option.add( basic::options::OptionKeys::score::nmer_svm_rank, "nmer svm rank scores filename (libsvm)" ).def("");
option.add( basic::options::OptionKeys::score::nmer_svm_rank_list, "list of nmer svm rank scores filenames (libsvm)" ).def("");
...
option.add( basic::options::OptionKeys::score::nmer_svm_avg_rank_as_energy, "use average of svm score ranks as rsd energy for NmerSVM scoring method, good for normalizing across mhc/hla alleles" ).def(false);
...
option.add( basic::options::OptionKeys::score::ideal_sugars, "Triggers loading of only the ideal chair conformations of sugars with 6 member rings." ).legal(true).legal(false).def(false);
...
option.add( basic::options::OptionKeys::score::alignment_sharpness, "When computing a harmonic function of RMSD for the alignment score, what should the standard deviation be?" ).def(1.0);
...
option.add( basic::options::OptionKeys::score::arg_cation_pi_his_can_be_pi, "For the arg_cation_pi scoreterm. Can histidine be the pi-side of an Arginine cation-pi interaction?" ).def(true);
option.add( basic::options::OptionKeys::score::mc_optimize_dG, "Optimize the dG during MonteCarlo.  It is not possible to do this within overall scoring, 			but where possible, do this during MC calls.  This option does not globally-use the MonteCarloInterface object, but is protocol-specific. 			This is due to needing to know the interface it will be used on. 			dG is measured by the InterfaceAnalyzerMover. 			Supported Code is currently RosettaAntibodyDesign and RosettaDock" ).def(false);
option.add( basic::options::OptionKeys::score::mc_interface_weight, "Weight of interface score if using MonteCarloInterface with a particular protocol." ).def(1.0);
option.add( basic::options::OptionKeys::score::mc_total_weight, "Weight of total score if using MonteCarloInterface with a particular protocol" ).def(0.0);
option.add( basic::options::OptionKeys::score::force_sugar_bb_zero, "Force the SugarBB weight to be zero from get_score_function.  			When using include_sugars, the sugar_bb weight is automatically added.  			This overrides that for benchmarking purposes" ).def(false);
option.add( basic::options::OptionKeys::score::voids_penalty_energy_containing_cones_cutoff, "A parameter for the voids_penalty score term.  The minimum number of cones projecting from side-chains in which a voxel must lie in order for that voxel to be considerd to be buried.  Defaults to 6 cones." ).def(6);
option.add( basic::options::OptionKeys::score::voids_penalty_energy_cone_dotproduct_cutoff, "A parameter for the voids_penalty score term.  The cutoff value for the dot product of a cone vector and a cone base-test point vector below which we declare the test point not to be within the cone.  Effectively, this is the cone width.  Lower values make broader cones.  Default 0.1.  Can range from 1.0 (infinitely thin cone) to -1.0 (full spherical volume), with 0.0 represeting all points on one side of the plane perpendicular to the cone vector." ).def(0.1);
option.add( basic::options::OptionKeys::score::voids_penalty_energy_cone_distance_cutoff, "A parameter for the voids_penalty score term.  The cutoff value for the distance from the cone base at which we are considered no longer to be within the cone.  Defaults to 8.0 Angstroms." ).def(8.0);
option.add( basic::options::OptionKeys::score::voids_penalty_energy_disabled_except_during_packing, "If true, then the voids_penalty term is only evaluated during packing (and not scoring or minimizing).  If false, then it is evaluated during packing and scoring (but not minimizing).  True by default.  Can be overridden for a particular ScoreFunction on a per-instance basis." ).def(true);
option.add( basic::options::OptionKeys::score::voids_penalty_energy_voxel_size, "The size, in Angstroms, of the voxels used in the voxel grid for the voids_penalty energy.  Defaults to 0.5 A (a cube with a side of 0.5 Angstroms)." ).def(0.5);
option.add( basic::options::OptionKeys::score::voids_penalty_energy_voxel_grid_padding, "A parameter for the voids_penalty energy.  This is the enlargement (on all sides) of the bounding box for the pose when setting up the voxel grid.  Defaults to 1.0 A padding on all sides." ).def(1.0);
option.add( basic::options::OptionKeys::score::rna::rna, "rna option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::score::rna::rna_base_pair_xy_filename, "File name where the RNA pase pair XY potential is defined" ).def("scoring/rna/rna_base_pair_xy.dat");
option.add( basic::options::OptionKeys::score::rna::disable_orientation_dependent_rna_ch_o_bonds, "Do not use orientation-dependent potential for RNA carbon hydrogen bonds" ).def(false);
option.add( basic::options::OptionKeys::score::rna::rna_suite_potential, "In RNA calculation, directory containing suite potentials" ).def("Richardson");
option.add( basic::options::OptionKeys::score::rna::suiteness_bonus, "In RNA calculation, directory containing suiteness bonus definition" ).def("Richardson");
option.add( basic::options::OptionKeys::score::rna::rna_torsion_skip_chainbreak, "Don't score RNA torsions located at the chain_breaks (aside from the ones that will be closed)" ).def(true);
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_verbose, "print out chemical shifts; useful for debug" ).def(false);
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_larmord, "Use LARMORD to calculate 1H chemical shifts" ).def(false);
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_exp_data, "rna_chemical_shift_exp_data" ).def("");
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_larmord_par, "larmord parameters file" ).def("larmord_1.0_nocut_parameters.dat");
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_larmord_wt, "larmord expected accuracy file" ).def("larmord_noweights.txt");
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_larmord_ref, "larmord reference  chemical shift file" ).def("larmord_1.0_reference_shifts.dat");
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_larmord_nei, "larmord neighbor atom shift file" ).def("larmord_1.0_neighbor_atoms.dat");
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_larmord_cut, "larmord distance cutoff" ).def(9999.9);
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_larmord_beta, "larmord beta value (the exponent)" ).def(-3.0);
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_H5_prime_mode, "rna_chemical_shift_H5_prime_mode" ).def("");
option.add( basic::options::OptionKeys::score::rna::rna_chemical_shift_include_res, "rna_chemical_shift_include_res" );
option.add( basic::options::OptionKeys::score::rna::DMS_separate_features, "in RNA DMS scoring, calculate N1-bonded, occupancy, and binding-energy-based scores as if they were uncorrelated     features and sum scores. " ).def(false);
option.add( basic::options::OptionKeys::score::rna::DMS_careful_base_pair_classifier, "in RNA lo-res DMS scoring, use detailed base pair classification to assess lores score " ).def(false);
option.add( basic::options::OptionKeys::score::rna::rna_chem_map_lores_weight, "In RNA lo-res chemical mapping scoring, final strength of rna_chem_map_lores term when -data_file is specified." ).def(0.0);
option.add( basic::options::OptionKeys::score::rna::use_2prime_OH_potential, "Use torsional potential for RNA 2prime OH." ).def(true);
option.add( basic::options::OptionKeys::score::rna::use_rna_chi_potential, "Use chi potential for RNA glyocosidic torsion." ).def(true);
option.add( basic::options::OptionKeys::score::rna::include_neighbor_base_stacks, "In RNA score calculation, include stacks between i,i+1" ).def(false);
option.add( basic::options::OptionKeys::score::rna::FA_low_res_rnp_scoring, "RNA/protein low-res scoring using full atom protein residues" ).def(false);
option.add( basic::options::OptionKeys::score::rna::free_suite_bonus, "Amount to reward virtualization of a nucleotide suite" ).def(-1.0);
option.add( basic::options::OptionKeys::score::rna::free_sugar_bonus, "Amount to reward virtualization of a sugar/ribose" ).def(-1.0);
option.add( basic::options::OptionKeys::score::rna::free_2HOprime_bonus, "Amount to reward virtualization of a 2'-OH" ).def(-0.5);
option.add( basic::options::OptionKeys::score::rna::syn_G_potential_bonus, "Amount to reward syn chi conformation of guanosine" ).def(0.0);
option.add( basic::options::OptionKeys::score::rna::rna_bulge_bonus_once_per_loop, "For legacy stepwise term rna_bulge in SWM runs, compute bulge bonus on a per-loop basis, rather than a bonus for each virtual residue." ).def(true);
option.add( basic::options::OptionKeys::score::rna::pack_phosphate_penalty, "Amount to penalize instantiation of a 5' or 3' phosphate" ).def(0.25);
...
option.add( basic::options::OptionKeys::score::loop_close::allow_complex_loop_graph, "LoopGraph hack - allow sharing of loops between cycles" ).def(true);
...
option.add( basic::options::OptionKeys::packing::dump_rotamer_sets, "Output NMR-style PDB's with the rotamer sets used during packing" ).def(false);
option.add( basic::options::OptionKeys::packing::dunbrack_prob_buried, "fraction of possible dunbrack rotamers to include in each single residue rotamer set, for 'buried' residues RotamericSingleResidueDunbrackLibrary" ).lower(0).upper(1).def(0.98);
option.add( basic::options::OptionKeys::packing::dunbrack_prob_nonburied, "fraction of possible dunbrack rotamers to include in each single residue rotamer set, for 'nonburied' residues RotamericSingleResidueDunbrackLibrary" ).lower(0).upper(1).def(0.95);
option.add( basic::options::OptionKeys::packing::dunbrack_prob_buried_semi, "fraction of possible dunbrack rotamers to include in each single residue rotamer set, for 'buried' residues in SemiRotamericSingleResidueDunbrackLibrary" ).lower(0).upper(1).def(0.95);
option.add( basic::options::OptionKeys::packing::dunbrack_prob_nonburied_semi, "fraction of possible dunbrack rotamers to include in each single residue rotamer set, for 'nonburied' residues in SemiRotamericSingleResidueDunbrackLibrary" ).lower(0).upper(1).def(0.87);
...
option.add( basic::options::OptionKeys::packing::flip_HNQ, "Consider flipping HIS, ASN, and GLN during hydrogen placement optimization (must turn off -no_optimizeH)" );
...
option.add( basic::options::OptionKeys::packing::sc_branch_rotamers, "construct rotamers for conjugated side chains. Warning: results in deformation of the conjugation bond length and angles, so should be followed by some correction" ).def(false);
...
option.add( basic::options::OptionKeys::packing::precompute_ig, "Explicitly request the O(N^2) interaction graph that precopmutes all 2-body energies. This option is overriden by linmem_ig." ).def(false);
...
option.add( basic::options::OptionKeys::packing::sequence_symmetric_annealer, "When used, the packer will enforce that all chains end up with the same sequence. 			It uses pdb info to link residues together, 			so all residues with the same pdb number will be the same amino acid in the end. 			If a residue does not have a partner on every chain, it will not be allowed to mutate. 			Like traditional symmetry, this assumes that all chains are part of the same symmetric system. 			It is impossible to have, say, chains A+B+C where A+B are symmetric and C is separate." ).def(false);
option.add( basic::options::OptionKeys::packing::smart_annealer, "(requires extras=tensorflow) Use AI to guide your packing protocol. Currently not usable with the multi_cool_annealer, but it may be soon." ).def(false);
option.add( basic::options::OptionKeys::packing::smart_annealer_model, "(requires extras=tensorflow) Choose which neural network to use for the smart annealer. Look at database/protocol_data/tensorflow_graphs/smart_annealer/ to see the options. Passing this flag enables '-smart_annealer'" ).def("jack3.07.1");
option.add( basic::options::OptionKeys::packing::smart_annealer_cutoff, "(requires extras=tensorflow) Choose a number from 0 to 1 to tune how aggressive the smart annealer is. Higher numbers are more agressive (risky) but have a potentially greater speedup (speedup requires -smart_annealer_pick_again false). Passing this flag enables '-smart_annealer'" ).def(0.25);
option.add( basic::options::OptionKeys::packing::smart_annealer_pick_again, "(requires extras=tensorflow) If disabled, the smart annealer just skips unfruitful amino acids. Enabling this option tells the annealer to pick a fruitful rotamer to sample this round instead of skipping the round. Will not give you a speedup but may give you a better final outcome. Passing this flag enables '-smart_annealer'" ).def(true);
option.add( basic::options::OptionKeys::packing::smart_annealer_disable_during_quench, "(requires extras=tensorflow) Run the final quenching stage as normal, regardless of how bad an amino acid may be. Passing this flag enables '-smart_annealer'" ).def(true);
...
option.add( basic::options::OptionKeys::packing::packer_palette::packer_palette, "packer_palette option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::packing::packer_palette::extra_base_type_file, "PackerPalettes define the set of residue types with which one is designing, and TaskOperations allow types to be turned off at specific positinos.  The default PackerPalette includes the twenty canonical amino acids.  If this option is used to provide a file containing a whitespace-separated list of residue type names, the default PackerPalette will include these additional residue types." );
option.add( basic::options::OptionKeys::packing::packer_palette::NCAA_expanded, "Design positions like beta-AAs, oligoureas, and polyaramids with a default set of options" );
...
option.add( basic::options::OptionKeys::carbohydrates::linkage_conformer_data_file, "Specify the file where glycosidic linkage conformer torsion angle statistical data is stored.  The default directory is database/chemical/carbohydrates/linkage_conformers/but any path can be provided.  The default filename is default.table" ).shortd( "Specify a file containing glycosidic linkage data." ).legal("default.table").legal("original.table").legal("core/chemical/carbohydrates/test_linkage_data_table.tsv").def("default.table");
option.add( basic::options::OptionKeys::carbohydrates::saccharide_sequence, "Input saccharide sequence to build." );
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::glycopeptide_docking, "glycopeptide_docking option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::residue_to_glycosylate, "Indicates to the Glycosylation Protocol which residue is being glycosylated." );
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::anchor_residue, "Indicates to the Glycosylation Protocol which residue is being glycosylated." );
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::low_res, "Indicate to the Glycosylation Protocol whether to perform low-resolution refinement of the substrate." ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::high_res_outer_cycles, "How many outer MC cycles to run with the high-resolution refinement." ).def(10);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::low_res_outer_cycles, "How many outer MC cycles to run with the low-resolution refinement." ).def(30);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::low_res_inner_cycles, "How many inner torsion sampling cycles to run with the low-resolution refinement." ).def(50);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::high_res, "Indicate to the Glycosylation Protocol whether to perform high-resolution refinement of the substrate." ).def(true);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::substrate_type, "Indicate the type of substrate that is being glycosylated i.e. peptide, protein, lipid, etc." ).def("peptide");
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::tree_type, "Indicate the type of foldtree to be used i.e. outward or downstream" ).def("outward");
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::randomize_substrate_torsions, "Randomize torsions of the substrate before running the protocol. Always on for abinitio docking. Can be turned on for refinement." ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::enable_backbone_moves_pp, "Enable backbone moves for peptide substrate." ).def(true);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::prevent_anchor_repacking, "Prevent glycosylated residue on the substrate from repacking." ).def(true);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::sugardonor_residue, "Residue number of UDPGalNac (or another sugar donating entity) in Rosetta Numbering for calculating distance with anomeric Carbon" ).def("-1");
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::output_debug_pdbs, "outputs large number of intermediate conformations from low and highres protocols" ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::fix_weights, "starting valu of repulsive weight is incorrectly ramped up instead of down - fix it" ).def(true);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::nevery_interface, "Every Nth move in high res mode for repacking interface residues" ).def("8");
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::ntotal_backbone, "Total backbone/rigid moves in high res mode" ).def("16");
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::allow_glycan_torsion_moves, "Add glycan to torsion movemap in highres" ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::interface_distance, "Interface distance for sidechain repacking in high res mode" ).def(8.0);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::score_only, "Skip docking. Score only with all glycopeptide/peptide docking metrics." ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::output_distance_metrics, "Output additional distance metrics." ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::preglycosylate_residues, "Comma separated residue positions in internal rosetta numbering." );
option.add( basic::options::OptionKeys::carbohydrates::glycopeptide_docking::preglycosylate_sugar_names, "Comma separated sugar names (eg. GalpNAc). Must match in number to option -glycopeptide_docking:preglycosylate_residues" );
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::glycan_sampler, "glycan_sampler option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::glycan_sampler_test, "Indicates to go into testing mode for Glycan Relax.  Will try all torsions in a given PDB in a linear fashion" ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::glycan_sampler_rounds, "Number of rounds to use for Glycan Relax. Total rounds is this # times number of glycan residues in movemap" ).def(100);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::min_rings, "Minimize Carbohydrate Rings during minimization?  Otherwise, we keep them at their input values (which is recommended)." ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::final_min_glycans, "Do a final minimization of glycans after glycan relax protocol?" ).def(true);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::glycan_sampler_movie, "Make a movie of accepts and trials (send to pymol)" ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::glycan_sampler_kt, "KT for GlycanRelaxMover" ).def(2.0);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::glycan_sampler_refine, "Set the protocol to not start from a random conformation, and instead refine the structure." ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::cartmin, "Use Cartesian-space minimization instead of dihedral" ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::tree_based_min_pack, "Use a random-tree based method to minimize and pack instead of minimizing and packing all of them during the randommover selection. This makes the speed of the algorithm mostly-linear with the addition of more glycans, and wastes less time packing and minimizing" ).def(true);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::population_based_conformer_sampling, "Use the populations of the conformers as probabilities during our linkage conformer sampling.  This makes it harder to overcome energy barriers with more-rare conformers" ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycan_sampler::use_gaussian_sampling, "Set whether to build conformer torsions using a gaussian of the angle or through uniform sampling up to 1 SD (default)" ).def(true);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::glycan_dock, "glycan_dock option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::n_repeats, "Number of times to restart the GlycanDock algorithm starting at Stage 2 if the final docked model does not pass the quality filter (< 0 Rosetta interaction energy). Default = 3" ).def(3);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::refine_only, "Perform refinement of the input putative complex only. Skips Stage 1 (conformational initialization via a random perturbation) and, during Stage 2, do not perform large perturbations in glycosidic torsion angle space. Default = false" ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::prepack_only, "Perform Stage 0 pre-packing of the input putative complex only. Separates the glycoligand from its protein receptor and optimizes all sidechain rotamer conformations. Default = false" ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::rand_glycan_jump_res, "Use a random, non-branch-point residue in the glycoligand as the Jump residue for the docking FoldTree. Default = true. False = docking FoldTree in which the residue closest to the center-of-mass of the glycoligand serves as the Jump residue" ).def(true);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::stage1_rotate_glycan_about_com, "During Stage 1 conformation initialization, rotate the glycoligand about its center-of-mass in uniform 3D space. Default = false. Recommended to set to true if confidence of the glycoligand's rigid-body orientation in the putative binding site is low." ).def(false);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::stage1_perturb_glycan_com_trans_mag, "During Stage 1 conformation initialization, this is the magnitude for performing a random translational Gaussian perturbation on the glycoligand's center-of-mass. Default = 0.5 (Angstroms)" ).def(0.5);

}
inline void add_rosetta_options_3( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::stage1_perturb_glycan_com_rot_mag, "During Stage 1 conformation initialization, this is the magnitude for performing a random rotational Gaussian perturbation on the glycoligand's center-of-mass. Default = 7.5 (degrees)" ).def(7.5);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::stage1_torsion_uniform_pert_mag, "During Stage 1 conformation initialization, the magnitude used to perform a uniform perturbation on each phi, psi, and omega glycosidic torsion angle. Default = 12.5 (degrees). stage1_use_LinkageConformerMover must be false." ).def(12.5);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::mc_kt, "During Stage 2 docking and refinement, the value of kT used to accept or reject moves based on the Metropolis criterion. Default = 0.6" ).def(0.6);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::n_rigid_body_rounds, "During Stage 2 docking and refinement, the number of rigid-body sampling rounds to perform each cycle. Default = 8" ).def(8);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::slide_glycan_into_contact, "During Stage 2 docking and refinement, occasionally slide the glycoligand toward the center-of-mass of the protein center. Helps ensure the glycoligand does not drift away from the protein receptor surface during docking. Default = true. Note: if the protein receptor has multiple chain IDs, its center-of-mass may cause the glycoligand to drift far from its starting location. Recommendation is to make the protein receptor one chain ID (e.g., chain A), or set this to false." ).def(true);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::stage2_trans_mag, "During Stage 2 docking and refinement, this is the magnitude for performing a translational Gaussian perturbation on the glycoligand's center-of-mass. The perturbation is accepted or rejected based on the Metropolis criterion. Default = 0.5 (Angstroms)" ).def(0.5);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::stage2_rot_mag, "During Stage 2 docking and refinement, this is the magnitude for performing a rotational Gaussian perturbation on the glycoligand's center-of-mass. The perturbation is accepted or rejected based on the Metropolis criterion. Default = 7.5 (degrees)" ).def(7.5);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::n_torsion_rounds, "During Stage 2 docking and refinement, the number of glycosidic torsion angle sampling rounds to perform each cycle. Default = 8" ).def(8);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::full_packing_frequency, "During Stage 2 docking and refinement, the frequency at which a full packing operation via the PackRotamersMover should be applied. Default = 8. Should be a factor of n_rigid_body_rounds and n_torsion_rounds. When not performing a full packing operation, the faster EnergyCutRotamerTrialsMover is applied." ).def(8);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::interface_packing_distance, "During Stage 2 docking and refinement, the distance used to define protein-glycoligand interface residues for packing. Default = 16 (Angstroms). Used for the RestrictToInterface task operation." ).def(16);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::ramp_scorefxn, "During Stage 2 docking and refinement, ramp the fa_atr and fa_rep score terms. fa_atr is set high and fa_rep is set low, and then ramped to their starting weights incrementally over the course of n_cycles. Default = true. Used to promote sampling by not strictly enforcing rigid sterics in the early stages of the protocol." ).def(true);
option.add( basic::options::OptionKeys::carbohydrates::glycan_dock::watch_in_pymol, "Watch the GlycanDock protocol in PyMOL? Sends the Pose at specific, hard-coded steps to PyMOL. Default = false. Used as an alternative to -show_simulation_in_pymol." ).def(false);
...
option.add( basic::options::OptionKeys::rings::ring_conformer_dbpath, "Path to ring conformers in the Rosetta DB" ).def("chemical/ring_conformer_sets");
...
option.add( basic::options::OptionKeys::chemical::add_atom_types, "Add additional atom types to an AtomTypeSet using atom_properties.txt formatted files; input format is a sequence of paired strings: <atom-type-set-tag1> <filename1> <atom-type-set-tag2> <filename2> ..." );
option.add( basic::options::OptionKeys::chemical::add_mm_atom_type_set_parameters, "Additional MMAtomTypeSet extra-parameter files that should be read; format is a sequence of paired string: <mm-atom-type-set-tag1> <filename1> <mm-atom-type-set-tag2> <filename2> ..." );
...
option.add( basic::options::OptionKeys::chemical::no_hbonds_to_ether_oxygens, "no H-bonds to nucleic acid ether oxygens O3', O4', O5' -- deprecated" ).def(false);
option.add( basic::options::OptionKeys::chemical::unset_acceptor_ether_oxygens, "nucleic acid ether oxygens O3', O4', O5' are not counted as acceptors" ).def(false);
...
option.add( basic::options::OptionKeys::corrections::beta, "Use the most-recent (curr Apr 2018) beta score function" ).def(false);
option.add( basic::options::OptionKeys::corrections::beta_cart, "Use the most-recent (curr Apr 2018) beta score function for nonideal optimization" ).def(false);
...
option.add( basic::options::OptionKeys::corrections::gen_potential, "Use the April 2018 genralized potential" ).def(false);
...
option.add( basic::options::OptionKeys::corrections::restore_talaris_behavior, "Use talaris score function and residue_type_set" ).def(false);
option.add( basic::options::OptionKeys::corrections::correct, "turn on default corrections:See src/core/init/score_function_corrections.cc.  Note that this is a flag for the older score12 scorefunction, which should NOT be used with talaris2013, talaris2014, ref2015, or the beta scorefunctions." ).def(false);
...
option.add( basic::options::OptionKeys::corrections::score::bbdep_omega, "Enable phi-psi dependent omega" ).def(true);
...
option.add( basic::options::OptionKeys::corrections::score::fa_dun_canonicals_use_voronoi, "If true, then canonical amino acids use Voronoi-style detection of neareset rotamer wells during fa_dun scoring instead of hard-coded rotamer well definitions.  False by default (i.e. hard-coded definitions are used by defaults)." ).def(false);
option.add( basic::options::OptionKeys::corrections::score::fa_dun_noncanonicals_use_voronoi, "If true, then noncanonical amino acids and other polymer building blocks use Voronoi-style detection of neareset rotamer wells during fa_dun scoring instead of hard-coded rotamer well definitions.  True by default (i.e. Voronoi-style detection is used by default).  Setting this to false creates problems with many noncanonicals that have rotamer wells that aren't simple gauche+/gauche-/anti wells." ).def(true);
option.add( basic::options::OptionKeys::corrections::score::fa_dun_correct_rotamer_well_order, "If true, the rotamer well order for rotamer files is corrected automatically to the Rosetta convention of lowest to highest in the range [0,360).  False by default." ).def(false);
option.add( basic::options::OptionKeys::corrections::score::fa_dun_correct_achiral_peptoid_libraries, "If true, the rotamer libraries for peptoids with achiral side-chains are symmetrized (so that mirror-image conformatoins score identically).  Rotamer library generation can produce slight asymmetries, so this is an easy way around that problem.  True by default." ).def(true);
...
option.add( basic::options::OptionKeys::corrections::score::hb_exclude_ether_oxygens, "no H-bonds to nucleic acid ether oxygens O3', O4', O5'" ).def(false);
...
option.add( basic::options::OptionKeys::corrections::score::no_autogen_cart_improper, "Ignore the auto parameter generation of improper torsions (undefined torsions) in CartesianBondedEnergy, generate_impropers_map_res." );
option.add( basic::options::OptionKeys::corrections::score::gridscore_outbox_penalty_weight, "The weight of the out-of-box penalty in gridscorer, i.e. out_of_bound_e_" ).def(100);
...
option.add( basic::options::OptionKeys::corrections::chemical::alternate_fullatom_ats, "Specify an alternate directory for the fullatom atom type set" );
option.add( basic::options::OptionKeys::corrections::genpotential::genpotential, "genpotential option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::corrections::genpotential::quick_lookup, "Use quick lookup in lookup_tors_params" ).def(false);
option.add( basic::options::OptionKeys::corrections::genpotential::set_torsion_params, "Modify generic_bonded_potential torsion parameters (the ones in generic_bonded.round6p.txt) from the command line. Format is: -corrections:genpotential:set_torsion_params <atom-set1>:<atom_name1>:<atom_name2>:<atom_name3>:<atom_name4><param1>:<setting1>:<param2>:<setting2> ... For example: '-corrections:genpotential:set_torsion_params fa_standard:C*:CS:CS:C*:k1:0.0:k2:0.0:k3:0.077 fa_standard:CD:CS:CS:CD:k1:0.435:k2:0.039:k3:0.070' " );
...
option.add( basic::options::OptionKeys::corrections::shapovalov_lib_fixes_enable, "Apply new code by Maxim Shapovalov from Dunbrack Lab such as for reading/using dun, rama, prop libraries in new format and options for applying different bug fixes. False value will employ old libraries and old code." ).def(true);
...
option.add( basic::options::OptionKeys::corrections::shapovalov_lib::shap_dun10_smooth_level, "Smoothing level either numeric or word keyword, possible values are 1 or lowest_smooth, 2 or lower_smooth, 3 or low_smooth, 4 or average_smooth, 5 or higher_smooth, 6 or highest_smooth." ).def("1");
...
option.add( basic::options::OptionKeys::corrections::shapovalov_lib::shap_p_aa_pp_smooth_level, "Smoothing level either numeric or word keyword, possible values are 1 or low_smooth, 2 or high_smooth." ).def("1");
...
option.add( basic::options::OptionKeys::corrections::water::water, "water option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::corrections::water::water_bump_check, "exclude water rotamers that dont pass energy bump check" ).def(false);
option.add( basic::options::OptionKeys::corrections::water::lkb_overlap_distance, "intersection distance when solvating with lkball sites" ).def(0.750);
option.add( basic::options::OptionKeys::corrections::water::lkb_cluster_radius, "radius for clustering overlapping lkball sites" ).def(1.000);
option.add( basic::options::OptionKeys::corrections::water::lkb_rotset_radius, "radius for grouping clustered water sites into rotamer sets" ).def(3.000);
option.add( basic::options::OptionKeys::corrections::water::wat_rot_params, "for statistical-based placement of potential water positions" ).def("sampling/waterrots/water.rots");
option.add( basic::options::OptionKeys::corrections::water::dwell_cutoff, "dwell time cutoff value for PWAT rotamers kept after normalizing by number of MC steps" ).def(0.02);
option.add( basic::options::OptionKeys::corrections::water::cluster_radius, "radius from dwell-weighted centroid for growing PWAT rotamer clusters" ).def(1.52);
option.add( basic::options::OptionKeys::corrections::water::cluster_cutoff, "remove cluster if cumulative dwell time is not met" ).def(0.179);
option.add( basic::options::OptionKeys::corrections::water::watlim_scale, "scale factor for waters kept if using limit_water: scale factor * # molten residues" ).def(0.0);
option.add( basic::options::OptionKeys::corrections::water::pointwater_params, "PWAT: directory name for pointwater potential databases" ).def("norm_trunc6");
option.add( basic::options::OptionKeys::corrections::water::ordered_pt_wat_penalty, "PWAT: Penalty for adding an ordered point water.  Implemented through pointwater scoreterm." ).def(2.709);
option.add( basic::options::OptionKeys::corrections::water::pointwat_wat_bonus, "PWAT: water-water bonus for nearby PWAT residues" ).def(0.52);
option.add( basic::options::OptionKeys::corrections::water::pointwat_wat_bonus_width, "PWAT: factor determining width of water-water bonus exponential function" ).def(17.1);
option.add( basic::options::OptionKeys::corrections::water::ordered_wat_penalty, "HOH: Penalty for adding an ordered water; implemented through ref scoreterm" ).def(1.221);
option.add( basic::options::OptionKeys::corrections::water::wat_rot_sampling, "Stepsize (in degrees) of rotatable waters" ).def(30.0);
option.add( basic::options::OptionKeys::corrections::water::wat_axis_sampling, "align O-H1 vector with nearby backbone O and sample about O-O axes" ).def(true);
option.add( basic::options::OptionKeys::corrections::water::axis_rot_sampling, "Stepsize (in degrees) of rotatable waters when wat_axis_sampling is used" ).def(15.0);
option.add( basic::options::OptionKeys::corrections::water::include_vrt, "allow for water virtualization" ).def(true);
option.add( basic::options::OptionKeys::enzymes::enzymes, "enzymes option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::enzymes::species, "Setting the species name limits the behavior of the simulated enzyme(s) used in this protocol to reactions known to occur in the given species.  A species name must be in the format \"e_coli\" or \"h_sapiens\", (note the underscores,) which must also correspond to a directory in the Rosetta database, e.g., \"database/virtual_enzymes/<enzyme_family>/h_sapiens/\"." ).shortd( "Set the species name of this simulated enzyme." ).def("h_sapiens");
option.add( basic::options::OptionKeys::enzymes::enzyme, "If set, the simulated enzyme used in this protocol will use specific enzymatic details for this reaction from the database.  If the species name has not been set, a \"generic\" enzyme from general family used in this protocol is assumed.  An enzyme name must be as listed in an appropriate enzyme file in \"database/virtual_enzymes/<enzyme_family>/<species_name_>/\"." ).shortd( "Set the specific enzyme name of this simulated enzyme." ).def("generic");
option.add( basic::options::OptionKeys::enzymes::efficiency, "If set, the simulated enzyme used in this protocol will have the efficiency indicated, where 1.00 is 100%.  A virtual enzyme with an efficiency of 0.50 will perform its reaction  any given site 50% of the time.  If not set, the value given in the database for this enzyme will be used.  Enzyme efficiency data are found in \"database/virtual_enzymes/<enzyme_family>/<species_name_>/\"." ).shortd( "Set the efficiency of this simulated enzyme." );
...
inline void add_rosetta_options_4( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::loops::build_specific_loops, "Numbers of the loops to be built" );
...
option.add( basic::options::OptionKeys::mp::restore_lazaridis_imm_behavior, "Restore energy function behavior to Lazaridis IMM1" ).def(false);
...
option.add( basic::options::OptionKeys::mp::membrane_core, "set membrane core thickness for Lazaridis-Karplus. default is 10A, i.e (-10, 10)" );
...
option.add( basic::options::OptionKeys::mp::lipids::lipids, "lipids option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::mp::lipids::composition, "Type of lipids to use in implicit model representation." ).def("DLPC");
option.add( basic::options::OptionKeys::mp::lipids::temperature, "Temperature at which the lipid composition parameters were measured" ).def(37.0);
option.add( basic::options::OptionKeys::mp::lipids::has_pore, "Manual override don't use pore estimation" );
...
option.add( basic::options::OptionKeys::mp::scoring::hbond, "Hydrogen bonding energy correction for membrane proteins" ).def(false);
option.add( basic::options::OptionKeys::mp::scoring::analytic_membetable_evaluation, "If true, membrane solvation energies will be calculated analytically, instead of ahead of time and stored in memb_etable" ).def(true);
...
option.add( basic::options::OptionKeys::mp::setup::span1, "Spanning topology file for partner 1" );
option.add( basic::options::OptionKeys::mp::setup::span2, "Spanning topology file for partner 2" );
...
option.add( basic::options::OptionKeys::mp::geo::geo, "geo option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::mp::geo::bicelle_radius, "Inner radius of bicelle. The bicelle inner_radius is the radius of the flat cylinder of the bicelle shape, the outer radius is the inner_radius+membrane_thickness. Setting the bicelle_radius as 0, would create an ellipsoid with a radius=membrane_thickness (default 15). Keep in mind that when setting the bicelle_radius, the size of the bicelle created is not dependent on the size of the protein. You will want to take the size of your protein into account when setting the bicelle_radius." );
option.add( basic::options::OptionKeys::mp::geo::vesicle_radius, "Radius of vesicle. Distance from center of the vesicle/sphere to the center of the membrane." );
option.add( basic::options::OptionKeys::mp::geo::double_vesicle_distance, "Distance between outer edge of inner vesicle membrane and inner edge of outer vesicle membrane. " );
...
option.add( basic::options::OptionKeys::mp::assembly::assembly, "assembly option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::mp::assembly::TM_pose_number, "Number of the PDB file in the -in:file:l list which is located in the membrane. Integer" );
option.add( basic::options::OptionKeys::mp::assembly::poses, "Filenames of the PDB files to consider. StringVector." );
...
option.add( basic::options::OptionKeys::mp::mutate_relax::mutation, "Vector of single mutations: Format: One-letter code / residue number / one-letter code. Example: A163F" );
...
option.add( basic::options::OptionKeys::mp::output::output_mem_to_pdb, "Do not output a MEM residue in the output PDB" );
...
option.add( basic::options::OptionKeys::optimization::cmaes_rgsigma, "CMAES initial coordinate wise standard deviation (step size)" ).def(0.3);
option.add( basic::options::OptionKeys::optimization::cmaes_lambda, "CMAES population size, default is defined as a function of dimension size (N) (i.e. 4+(int)(3*log((double)N))), set default using value < 2" ).def(0);
...
inline void add_rosetta_options_5( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::symmetry::reweight_symm_interactions, "Scale intersubunit interactions by a specified weight" ).def(1.0);
...
option.add( basic::options::OptionKeys::abinitio::use_trRosetta_constraints, "If true, the trRosetta neural network is used to add constraints, based on the input sequence, to the pose to guide the structure prediction trajectory based on an input sequence or multiple sequence alignment.  Requires that Rosetta has been compiled with -extras=tensorflow or -extras=tensorflow_gpu." ).def(false);
...
option.add( basic::options::OptionKeys::simple_metrics::simple_metrics, "simple_metrics option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::simple_metrics::use_name_as_custom_type, "Use the name of the tag as the custom_type unless a custom_type. For use outside of Protocols section" ).def(false);
option.add( basic::options::OptionKeys::simple_metrics::use_name_as_metric, "Use the name of the tag as the full name of the metric. For use outside of Protocols section. " ).def(false);
option.add( basic::options::OptionKeys::antibody::antibody, "Antibody option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::antibody::input_ab_scheme, "The numbering scheme of the PDB file." ).legal("Chothia").legal("Enhanced_Chothia").legal("AHo").legal("AHO").legal("IMGT").legal("Kabat").legal("Chothia_Scheme").legal("Enhanced_Chothia_Scheme").legal("AHo_Scheme").legal("AHO_Scheme").legal("IMGT_Scheme").legal("Kabat_Scheme").def("Chothia_Scheme");
...
option.add( basic::options::OptionKeys::antibody::run_snugdock, "Run Snugdock after Antibody_H3/RAbD?" ).def(false);
...
option.add( basic::options::OptionKeys::antibody::h3_loop_csts_lr, "Turn on/off the dihedral angle and atom pair constraint weights in the low-resolution score function used during H3 loop modeling" ).def(true);
option.add( basic::options::OptionKeys::antibody::h3_loop_csts_hr, "Turn on/off the dihedral angle and atom pair constraint weights in the high-resolution score function used during H3 loop modeling" ).def(true);
option.add( basic::options::OptionKeys::antibody::auto_generate_h3_kink_constraint, "Generate the kink constraint on-the-fly for either the low-resolution or high-resolution H3 modeling stages, depending on h3_loop_csts flags." ).def(true);
option.add( basic::options::OptionKeys::antibody::constrain_vlvh_qq, "Turn on/off a constraint forcing the VL-VH QQ H-bond in docking scoring function" ).def(true);
...
option.add( basic::options::OptionKeys::antibody::exclude_pdbs, "do not use given pdb(s) as sources for grafting (no default), e.g. 1ABC 2CDE" );
...
option.add( basic::options::OptionKeys::antibody::bfactor_cutoff, "Exclude templates regions with an average bfactor above the cutoff (80 is default)." ).def(80.0);
...
option.add( basic::options::OptionKeys::antibody::json_cdr, "define cdr begin/end points with input json" );
option.add( basic::options::OptionKeys::antibody::design::design, "design option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::antibody::design::view, "Enable viewing of the antibody design run. Must have built using extras=graphics and run with antibody_designer.graphics executable" ).def(false);
...
option.add( basic::options::OptionKeys::antibody::design::seq_design_cdrs, "Enable these CDRs for Sequence-Design.  (Can be set here or in the instructions file. Overrides any set in instructions file if given)" ).legal("L1").legal("L2").legal("L3").legal("H1").legal("H2").legal("H3").legal("l1").legal("l2").legal("l3").legal("h1").legal("h2").legal("h3").legal("H4").legal("L4").legal("h1").legal("h4");
option.add( basic::options::OptionKeys::antibody::design::graft_design_cdrs, "Enable these CDRs for Graft-Design.  (Can be set here or in the instructions file. Overrides any set in instructions file if given)" ).legal("L1").legal("L2").legal("L3").legal("H1").legal("H2").legal("H3").legal("l1").legal("l2").legal("l3").legal("h1").legal("h2").legal("h3");
option.add( basic::options::OptionKeys::antibody::design::primary_cdrs, "Manually set the CDRs which can be chosen in the outer cycle. Normally, we pick any that are sequence or graft -designing." ).legal("L1").legal("L2").legal("L3").legal("H1").legal("H2").legal("H3").legal("l1").legal("l2").legal("l3").legal("h1").legal("h2").legal("h3").legal("H4").legal("L4").legal("h1").legal("h4");
option.add( basic::options::OptionKeys::antibody::design::mintype, "The default mintype for all CDRs.  Individual CDRs may be set via the instructions file" ).legal("min").legal("cartmin").legal("relax").legal("backrub").legal("pack").legal("dualspace_relax").legal("cen_relax").legal("none").def("min");
option.add( basic::options::OptionKeys::antibody::design::disallow_aa, "Disallow certain amino acids while sequence-designing (could still be in the graft-designed sequence, however).  Useful for optimizing without, for example, cysteines and prolines. Applies to all sequence design profiles and residues from any region (cdrs, framework, antigen).  You can control this per-cdr (or only for the CDRs) through the CDR-instruction file. A resfile is also accepted if you wish to limit specific positions directly." ).legal("ALA").legal("CYS").legal("ASP").legal("GLU").legal("PHE").legal("GLY").legal("HIS").legal("ILE").legal("LYS").legal("LEU").legal("MET").legal("ASN").legal("PRO").legal("GLN").legal("ARG").legal("SER").legal("THR").legal("VAL").legal("TRP").legal("TYR").legal("A").legal("C").legal("D").legal("E").legal("F").legal("G").legal("H").legal("I").legal("K").legal("L").legal("M").legal("N").legal("P").legal("Q").legal("R").legal("S").legal("T").legal("V").legal("W").legal("Y");
...
option.add( basic::options::OptionKeys::antibody::design::high_mem_mode, "If false, we load the CDRSet (CDRs loaded from the database that could be grafted) on-the-fly for a CDR if it has more than 50 graft-design members.  If true, then we cache the CDRSet before the start of the protocol.  Typically, this will really only to come into play when designing all CDRs.  For de-novo design of 5/6 CDRs, without limiting the CDRSet in the instructions file, you will need 3-4 gb per process for this option." ).def(false);
option.add( basic::options::OptionKeys::antibody::design::cdr_set_cache_limit, "If high_mem_mode is false, this is the limit of CDRSet cacheing we do before we begin load them on-the-fly instead.  If high_mem_mode is true, then we ignore this setting.  If you have extremely low memory per-process, lower this number" ).def(300);
...
option.add( basic::options::OptionKeys::antibody::design::relax_cycle_rounds, "Rounds of relax that are run after each inner cycle. The default recommendation is 5 cycles for FastRelax.				If you decrease this number, you will decrease your run time significantly. This has not been benchmarked though." ).def(5);
...
option.add( basic::options::OptionKeys::antibody::design::no_profile_probabilities, "Set to sample all available AAs per position instead of sampling based on weights.  Used to increase diversity and testing purposes." ).def(false);
...
option.add( basic::options::OptionKeys::antibody::design::idealize_graft_cdrs, "Idealize the CDR before grafting.  May help or hinder. " ).def(false);
...
option.add( basic::options::OptionKeys::antibody::design::inner_kt, "KT used in the inner min monte carlo after each graft." ).def(1.0);
...
inline void add_rosetta_options_6( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::bunsat_calc2::sulph_dist_cutoff, "max sulph dist" ).def(3.3);
...
option.add( basic::options::OptionKeys::cloud::cloud, "cloud option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::cloud::auth, "RosettaCloud credentials in form of <user_email>:<password>. To get your credentials visit https://ui.graylab.jhu.edu/settings" ).def("");
option.add( basic::options::OptionKeys::cloud::key, "Key to use when process query Cloud server for new ExecutionSummary ID, default is empty string (no key) which mean always create a new ES instance" ).def("");
option.add( basic::options::OptionKeys::cloud::clean, "When option `key` is specified tell if Cloud server should clean exising ExecutionSummary instance from all existing files" ).def(false);
option.add( basic::options::OptionKeys::cloud::host, "UI server address" ).def("ui.graylab.jhu.edu");
option.add( basic::options::OptionKeys::cloud::port, "UI server port" ).def(80);
option.add( basic::options::OptionKeys::cloud::block, "Specify what to do when network queue is full: block and wait for packets to be be send or drop payload" ).def(true);
...
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::energy_based_clustering, "energy_based_clustering option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::prerelax, "Should imported structures be subjected to a round of fast relaxation?  Default false." ).def(false);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::relax_rounds, "The number of fastrelax rounds to apply if the -cluster:energy_based_clustering:prerelax option is used.  Default 1." ).def(1);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::cluster_by, "What should I use as the basis for clustering?  Options are bb_cartesian (xyz coordinates of backbone atoms) and bb_dihedral (phi, psi, omega angles).  Default is bb_cartesian." ).legal("bb_cartesian").legal("bb_dihedral").def("bb_cartesian");
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::use_CB, "If clustering by backbone Cartesian coordinates, should beta carbons be included?  Default false.  Note that if this option is used, none of the input structures can contain glycine." ).def(false);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::cluster_radius, "The radius for clustering, in Angstroms for Cartesian clustering and degrees for dihedral clustering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::residues_to_ignore, "List of residues to ignore in alignments for clustering.  Default empty list." );
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::chains_to_ignore, "List of chains to ignore in alignments for clustering.  Default empty list." );
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::limit_structures_per_cluster, "Maximum number of structures to output per cluster.  Default no limit (0)." ).def(0);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::limit_clusters, "Maximum number of clusters to output.  Default no limit (0)." ).def(0);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::cyclic, "If true, constraints are added to make a peptide bond between the N- and C-termini.  If false (default), the termini are free.  Default false." ).def(false);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::cyclic_symmetry, "If provided, structures that do not have the desired symmetry are filtered out.  Set to 2 for C2 or S2 symmetry, 3 for C3 symmetry, 4 for C4 or S4 symmetry, etc.  Unused (0) if not specified.  Can only be used with the -cluster:energy_based_clustering:cyclic flag." ).def(0);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::cyclic_symmetry_mirroring, "If true, then SN symmetry is used instead of CN.  Unused if not specified.  Can only be used with the -cluster:energy_based_clustering:cyclic and -cluster:energy_based_clustering:cyclic_symmetry flags." ).def(false);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::cyclic_symmetry_threshold, "The angle threshold, in degrees, for determining whether a cyclic peptide is symmetric.  Can only be used with the -cluster:energy_based_clustering:cyclic and -cluster:energy_based_clustering:cyclic_symmetry flags.  Defaults to 10.0 degrees." ).def(10.0);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::cluster_cyclic_permutations, "If true, all cyclic permutations are tried when comparing two structures for clustering.  Requires -cluster:energy_based_clustering:cyclic true.  Default false." ).def(false);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::cyclic_permutation_offset, "1 by default, meaning that every cyclic permutation is clustered if -cluster:energy_based_clustering:cluster_cyclic_permutations is true.  Values X > 1 mean that cyclic permutations shifted by X residues will be clustered." ).def(1);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::perform_ABOXYZ_bin_analysis, "If true, Ramachandran bin analysis is performed on all clusters using the A, B, X, Y, and O bins as defined in Hosseinzadeh, Bhardwaj, Mulligan et al. (2018).  Inputs must be all-alpha amino acid or peptoid structures.  False by default." ).def(false);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::mutate_to_ala, "If true, the input structures will be converted to a chain of alanines (L- or D-) before scoring.  Default false." ).def(false);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::disulfide_positions, "A space-separated list of positions that are disulfide-bonded.  For example, -cluster:energy_based_clustering:disulfide_positions 3 8 6 23 would mean that residues 3 and 8 are disulfide-bonded, as are residues 6 and 23.  Defaults to an empty list of the option is not specified, in which case disulfides are auto-detected." );
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::homooligomer_swap, "If the structures contain multiple chains with identical sequence, setting this to true will test all permutations of chains when clustering.  Default false." ).def(false);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::silent_output, "Write output to a silent file instead of to separate PDBs.  This will create two files: one that only contains the first member of each cluster, and one that contains everything.  Default false." ).def(false);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::cst_file, "An optional, user-specified list of one or more constraints files.  Default unused." );
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::extra_rms_atoms, "A list of additional atoms to use in the RMSD calculation, each in the format residue:atomname separated by whitespace.  For example, -extra_rms_atoms 7:SG 12:CG 12:CD 12:CE 12:NZ 14:OG.  Default empty list." );
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::rebuild_all_in_dihedral_mode, "If true, full poses are rebuilt for output when clustering in dihedral mode.  If false, only backbones are written out.  True by default." ).def(true);
option.add( basic::options::OptionKeys::cluster::energy_based_clustering::alternative_score_file, "A file containing one line per Structure with the pose input file name and an alternative score to sort by seperated by whitespace." );
option.add( basic::options::OptionKeys::partial_thread::partial_thread, "partial_thread option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::partial_thread::skip_repack, "Do not repack sidechain missing density and idealize/optimize h-bonds" ).def(false);
...
option.add( basic::options::OptionKeys::cm::seeds, "list of tags used as seed parents at prv iteration" );
option.add( basic::options::OptionKeys::cm::nremain_reset, "threshold for number of unused structures to invoke reset" ).def(3);
option.add( basic::options::OptionKeys::cm::quota_per_silent, "quota for picking input structures associated with -in:file:silent" );
option.add( basic::options::OptionKeys::cm::similarity_cut, "Distance cut on the structure population, used for CSA (in S-score)" );
option.add( basic::options::OptionKeys::cm::similarity_limit, "Distance cut for initial filtering (in S-score)" );
option.add( basic::options::OptionKeys::cm::refsimilarity_cut, "Lower threshold on model-to-template GDT-HA where it starts to get penalty" ).def(25);
...
option.add( basic::options::OptionKeys::constel::constel, "constel option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::constel::pair_all_res, "extracts all constellations formed by all pairs of residues" ).def(false);
option.add( basic::options::OptionKeys::constel::triple_all_res, "extracts all constellations formed by all triads of residues" ).def(false);
option.add( basic::options::OptionKeys::constel::pair_target_resnum, "PDB residue number of target residue for two-residue constellations" ).def(-1);
option.add( basic::options::OptionKeys::constel::triple_target_resnum, "PDB residue number of target residue for three-residue constellations" ).def(-1);
option.add( basic::options::OptionKeys::constel::target_chain, "PDB chain ID of target residue" ).def("A");
option.add( basic::options::OptionKeys::constel::pair_target_mutations, "Target mutation pair for two-residue constellations" ).def("**_**");
option.add( basic::options::OptionKeys::constel::target_cnl, "Path to the file describing the target constellation" ).def("");
option.add( basic::options::OptionKeys::constel::cnl_stripped, "Deprives constellations of the atoms closest to the backbone" ).def(false);
option.add( basic::options::OptionKeys::constel::max_atom_sasa, "Maximum allowed SASA for a constellation atom" ).def(999999.9);
option.add( basic::options::OptionKeys::constel::chain_interface, "Keeps only constellations shared by multiple chains" ).def(false);
option.add( basic::options::OptionKeys::constel::aromatic, "Keeps only constellations with at least one aromatic ring" ).def(false);
option.add( basic::options::OptionKeys::constel::cnl_exclude, "Path to the file listing the residues to be excluded from constellations" ).def("");
option.add( basic::options::OptionKeys::constel::prox_ct_max, "Maximum distance of a constellation to a chain terminus" ).def(0);
option.add( basic::options::OptionKeys::constel::prox_tt_max, "Maximum distance between chain termini" ).def(10.0);
option.add( basic::options::OptionKeys::constel::prox_nres, "Number of residues forming a chain terminus" ).def(10);
option.add( basic::options::OptionKeys::constel::indole_coo, "Keeps only constellations formed by an indole group plus a COO group" ).def(false);
option.add( basic::options::OptionKeys::constel::tryptamine, "Keeps only constellations that can be matched by tryptamine" ).def(false);
option.add( basic::options::OptionKeys::constel::amphetamine, "Keeps only constellations that can be matched by amphetamine" ).def(false);
option.add( basic::options::OptionKeys::constel::histamine, "Keeps only constellations that can be matched by histamine" ).def(false);
...
option.add( basic::options::OptionKeys::coupled_moves::walking_perturber_magnitude, "Degree parameter for coupled moves kic walking perturber." ).def(2.0);
option.add( basic::options::OptionKeys::coupled_moves::kic_loop_size, "KIC will try to change the torsion angles of a segment this many residues long. The rotamer of the middle residue will be designed, thus kic_loop_size must be an odd number so a middle residue exists. (Backrub segment length is hardcoded in ShortBackrubMover as 3-residue, or 4-residue if it hits a Proline)." ).def(9);
option.add( basic::options::OptionKeys::coupled_moves::kic_perturber, "Which perturber to use during kinematic closure (KIC). Current options are walking (default) or fragment. Walking perturber adjusts torsions by degrees, the magnitude of which can be set by -walking_perturber_magnitude. If you specify walking you MAY also specify -walking_perturber_magnitude. If you specify fragment you MUST also specify -loops::frag_files and -loops::frag_sizes." ).legal("walking").legal("fragment").def("walking");
option.add( basic::options::OptionKeys::coupled_moves::backbone_mover, "Which backbone mover to use. Current options are backrub (default) or kic. Backrub does not require additional flags, and uses ShortBackrubMover which is hardcoded for 3-residue segments (or 4-residue if it hits a Proline). Kic optionally takes extra flag -kic_perturber." ).legal("backrub").legal("kic").def("backrub");
option.add( basic::options::OptionKeys::coupled_moves::repack_neighborhood, "After the backbone move and rotamer move, repack sidechains within 5A of the design residue. Default false for legacy behavior (legacy = Ollikainen 2015)." ).def(false);
option.add( basic::options::OptionKeys::coupled_moves::exclude_nonclashing_positions, "True = For each packable position, ClashBasedShellSelector iterates through rotamers to determine if the residue could clash with any designable positions. If a clash isnt possible, the packable position is changed from NATAA to NATRO. False = Perform side chain moves strictly as defined in resfile. Default true reproduces behavior from Ollikainen 2015." ).def(true);
...
option.add( basic::options::OptionKeys::cyclic_peptide::cyclization_type, "The type of cyclization for the peptide (e.g. N-to-C amide bond, terminal disulfide, thioether lariat, isopeptide N-terminal lariat, etc." ).legal("n_to_c_amide_bond").legal("terminal_disulfide").legal("thioether_lariat").legal("nterm_isopeptide_lariat").legal("cterm_isopeptide_lariat").legal("sidechain_isopeptide").def("n_to_c_amide_bond");
option.add( basic::options::OptionKeys::cyclic_peptide::use_chainbreak_energy, "If true, then the chainbreak energy is used to preserve any N-to-C peptide bond (assuming that this is an N-to-C cyclic peptide).  If false, then constraints are used instead.  True by default." ).def(true);
...
option.add( basic::options::OptionKeys::cyclic_peptide::exclude_residues_from_rms, "A list of residues that should be excluded from the RMSD calculation.  Not used if not provided." );
...
inline void add_rosetta_options_7( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::cyclic_peptide::min_final_hbonds, "The minimum number of backbone hbonds for a solution to pass after final relaxtion in the simple_cycpep_predict app.  Default 0 (report only)." ).def(0.0);
...
option.add( basic::options::OptionKeys::cyclic_peptide::bondlength_perturbation_magnitude, "If used, this is the magnitude (in Angstroms) of the perturbation to apply to mainchain bond lengths when closing with GenKIC.  This can be useful for small, strained macrocycles.  No bond length perturbation is applied if this option is not specified." ).def(0.0);
option.add( basic::options::OptionKeys::cyclic_peptide::bondangle_perturbation_magnitude, "If used, this is the magnitude (in degrees) of the perturbation to apply to mainchain bond angles when closing with GenKIC.  This can be useful for small, strained macrocycles.  No bond angle perturbation is applied if this option is not specified." ).def(0.0);
...
option.add( basic::options::OptionKeys::cyclic_peptide::lariat_sidechain_index, "If a lariat cyclization type is specified (e.g. nterm_isopeptide_lariat, cterm_isopeptide_lariat), then this is the residue that provides the side-chain that connects to the N- or C-terminus of the peptide.  If not specified, the residue of appropriate type closest to the other end is used." ).def(0);
option.add( basic::options::OptionKeys::cyclic_peptide::sidechain_isopeptide_indices, "If the sidechain_isopeptide cyclization type is specified, these are the indices of the residues that are linked by a sidechain-sidechain isopeptide bond to make the loop.  If not specified, the residues furthest apart of appropriate types are used.  Note that exactly two indices must be given." );
option.add( basic::options::OptionKeys::cyclic_peptide::paraBBMB_positions, "If provided, then these positions will be linked by a 1,4-bis(bromomethyl)benzene, or para-BBMB, crosslinker.  2N positions must be specified, and every group of two will be linked.  Unused if not specified." );
option.add( basic::options::OptionKeys::cyclic_peptide::use_paraBBMB_filters, "If true, then filters are applied based on distance between BBMB cysteines and on constraints to discard GenKIC solutions that can't be crosslinked easily.  True by default." ).def(true);
option.add( basic::options::OptionKeys::cyclic_peptide::paraBBMB_sidechain_distance_filter_multiplier, "A multiplier for the distance cutoff for BBMB cysteines.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::paraBBMB_constraints_energy_filter_multiplier, "A multiplier for the constraints energy for BBMB cysteines.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::link_all_cys_with_paraBBMB, "If true, then all cysteine residues in the peptide are linked with 1,4-bis(bromomethyl)benzene.  There must be exactly two cysteine residues for this flag to be used, and it cannot be used with the -paraBBMB_positions flag, the -TBMB_positions flag, or the -link_all_cys_with_TBMB flag.  False/unused by default." ).def(false);
option.add( basic::options::OptionKeys::cyclic_peptide::TBMB_positions, "If provided, then these positions will be linked by a 1,3,5-tris(bromomethyl)benzene, or TBMB, crosslinker.  3N positions must be specified, and every group of three will be linked.  Unused if not specified." );
...
option.add( basic::options::OptionKeys::cyclic_peptide::link_all_cys_with_TBMB, "If true, then all cysteine residues in the peptide are linked with 1,3,5-tris(bromomethyl)benzene.  There must be exactly three cysteine residues for this flag to be used, and it cannot be used with the -paraBBMB_positions flag, the -TBMB_positions flag, or the -link_all_cys_with_paraBBMB flag.  False/unused by default." ).def(false);
option.add( basic::options::OptionKeys::cyclic_peptide::TMA_positions, "If provided, then these positions will be linked by a trimesic acid crosslinker.  The positions must have sidechain primary amines (i.e. be one of lysine [LYS], ornithine [ORN], 2,4-diaminobutyric acid [DAB], or 2,3-diaminopripionic acid [DPP].  There must be 3N positions specified, and every group of three will be linked.  Unused if not specified." );
option.add( basic::options::OptionKeys::cyclic_peptide::use_TMA_filters, "If true, then filters are applied based on distance between TMA-conjugated sidechains and on constraints to discard GenKIC solutions that can't be crosslinked easily.  True by default." ).def(true);
option.add( basic::options::OptionKeys::cyclic_peptide::TMA_sidechain_distance_filter_multiplier, "A multiplier for the distance cutoff for side-chains linked by trimseic acid (TMA).  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::TMA_constraints_energy_filter_multiplier, "A multiplier for the constraints energy for side-chains linked by trimseic acid (TMA).  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::square_pyramidal_metal_positions, "If provided, then these positions will coordinate a metal with square pyramidal coordination.  The positions must have sidechains that can coordinate a metal (e.g. histidine, aspartate, glutamate).  The positions should be specified in the form res1,res2,res3,res4,res5,metal.  For example, if positions 4, 6, 9, 13, and 16 were to coordinate a nickel, the string would be 4,6,9,13,16,Ni2.  Multiple sets of metal-coordinating side-chains can be specified, separated by a space.  The metal will be represented by virtual atoms, and will not be modelled explicitly.  Unused if not specified." );
option.add( basic::options::OptionKeys::cyclic_peptide::use_square_pyramidal_metal_filters, "If true, then filters are applied based on distance between metal-conjugated sidechains and on constraints to discard GenKIC solutions that can't be crosslinked with a metal easily.  True by default." ).def(true);
option.add( basic::options::OptionKeys::cyclic_peptide::square_pyramidal_metal_sidechain_distance_filter_multiplier, "A multiplier for the distance cutoff for side-chains linked by a metal coordinated with square pyramidal coordination.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::square_pyramidal_metal_constraints_energy_filter_multiplier, "A multiplier for the constraints energy for side-chains linked by a metal coordinated with square pyramidal coordination.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::square_planar_metal_positions, "If provided, then these positions will coordinate a metal with square planar coordination.  The positions must have sidechains that can coordinate a metal (e.g. histidine, aspartate, glutamate).  The positions should be specified in the form res1,res2,res3,res4,metal.  For example, if positions 6, 9, 13, and 17 were to coordinate a nickel, the string would be 6,9,13,17,Ni2.  Multiple sets of metal-coordinating side-chains can be specified, separated by a space.  The metal will be represented by virtual atoms, and will not be modelled explicitly.  Unused if not specified." );
option.add( basic::options::OptionKeys::cyclic_peptide::use_square_planar_metal_filters, "If true, then filters are applied based on distance between metal-conjugated sidechains and on constraints to discard GenKIC solutions that can't be crosslinked with a metal easily.  True by default." ).def(true);
option.add( basic::options::OptionKeys::cyclic_peptide::square_planar_metal_sidechain_distance_filter_multiplier, "A multiplier for the distance cutoff for side-chains linked by a metal coordinated with square planar coordination.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::square_planar_metal_constraints_energy_filter_multiplier, "A multiplier for the constraints energy for side-chains linked by a metal coordinated with square planar coordination.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::trigonal_pyramidal_metal_positions, "If provided, then these positions will coordinate a metal with trigonal pyramidal coordination.  The positions must have sidechains that can coordinate a metal (e.g. histidine, aspartate, glutamate).  The positions should be specified in the form res1,res2,res3,metal.  For example, if positions 6, 9, and 13 were to coordinate a zinc, the string would be 6,9,13,Zn.  Multiple sets of metal-coordinating side-chains can be specified, separated by a space.  The metal will be represented by virtual atoms, and will not be modelled explicitly.  Unused if not specified." );
option.add( basic::options::OptionKeys::cyclic_peptide::use_trigonal_pyramidal_metal_filters, "If true, then filters are applied based on distance between metal-conjugated sidechains and on constraints to discard GenKIC solutions that can't be crosslinked with a metal easily.  True by default." ).def(true);
option.add( basic::options::OptionKeys::cyclic_peptide::trigonal_pyramidal_metal_sidechain_distance_filter_multiplier, "A multiplier for the distance cutoff for side-chains linked by a metal coordinated with trigonal pyramidal coordination.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::trigonal_pyramidal_metal_constraints_energy_filter_multiplier, "A multiplier for the constraints energy for side-chains linked by a metal coordinated with trigonal pyramidal coordination.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::trigonal_planar_metal_positions, "If provided, then these positions will coordinate a metal with trigonal planar coordination.  The positions must have sidechains that can coordinate a metal (e.g. histidine, aspartate, glutamate).  The positions should be specified in the form res1,res2,res3,metal.  For example, if positions 6, 9, and 13 were to coordinate a zinc, the string would be 6,9,13,Zn.  Multiple sets of metal-coordinating side-chains can be specified, separated by a space.  The metal will be represented by virtual atoms, and will not be modelled explicitly.  Unused if not specified." );
option.add( basic::options::OptionKeys::cyclic_peptide::use_trigonal_planar_metal_filters, "If true, then filters are applied based on distance between metal-conjugated sidechains and on constraints to discard GenKIC solutions that can't be crosslinked with a metal easily.  True by default." ).def(true);
option.add( basic::options::OptionKeys::cyclic_peptide::trigonal_planar_metal_sidechain_distance_filter_multiplier, "A multiplier for the distance cutoff for side-chains linked by a metal coordinated with trigonal planar coordination.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::trigonal_planar_metal_constraints_energy_filter_multiplier, "A multiplier for the constraints energy for side-chains linked by a metal coordinated with trigonal planar coordination.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::tetrahedral_metal_positions, "If provided, then these positions will coordinate a metal, tetrahedrally.  The positions must have sidechains that can coordinate a metal (e.g. histidine, aspartate, glutamate).  The positions should be specified in the form res1,res2,res3,res4,metal.  For example, if positions 4, 6, 9, and 13 were to coordinate a zinc, the string would be 4,6,9,13,Zn.  Multiple sets of metal-coordinating side-chains can be specified, separated by a space.  The metal will be represented by virtual atoms, and will not be modelled explicitly.  Unused if not specified." );
option.add( basic::options::OptionKeys::cyclic_peptide::use_tetrahedral_metal_filters, "If true, then filters are applied based on distance between metal-conjugated sidechains and on constraints to discard GenKIC solutions that can't be crosslinked with a metal easily.  True by default." ).def(true);
option.add( basic::options::OptionKeys::cyclic_peptide::tetrahedral_metal_sidechain_distance_filter_multiplier, "A multiplier for the distance cutoff for side-chains linked by a tetrahedrally-coordinated metal.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::tetrahedral_metal_constraints_energy_filter_multiplier, "A multiplier for the constraints energy for side-chains linked by a tetrahedrally-coordinated metal.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::octahedral_metal_positions, "If provided, then these positions will coordinate a metal, octahedrally.  The positions must have sidechains that can coordinate a metal (e.g. histidine, aspartate, glutamate).  The positions should be specified in the form res1,res2,res3,res4,res5,res6,metal.  For example, if positions 4, 6, 9, 13, 16, and 18 were to coordinate an iron(II), the string would be 4,6,9,13,Fe2.  Multiple sets of metal-coordinating side-chains can be specified, separated by a space.  The metal will be represented by virtual atoms, and will not be modelled explicitly.  Unused if not specified." );
option.add( basic::options::OptionKeys::cyclic_peptide::use_octahedral_metal_filters, "If true, then filters are applied based on distance between metal-conjugated sidechains and on constraints to discard GenKIC solutions that can't be crosslinked with a metal easily.  True by default." ).def(true);
option.add( basic::options::OptionKeys::cyclic_peptide::octahedral_metal_sidechain_distance_filter_multiplier, "A multiplier for the distance cutoff for side-chains linked by a octahedrally-coordinated metal.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::octahedral_metal_constraints_energy_filter_multiplier, "A multiplier for the constraints energy for side-chains linked by a octahedrally-coordinated metal.  Higher values result in more permissive filtering.  Default 1.0." ).def(1.0);
...
option.add( basic::options::OptionKeys::cyclic_peptide::MPI_auto_2level_distribution, "If true, will automatically set up job distribution with one director talking to N-1 workers, where N is the total number of processes.  Cannot be used with -MPI_processes_by_level.  Default false." ).def(false);
option.add( basic::options::OptionKeys::cyclic_peptide::MPI_processes_by_level, "The number of processes at each level of the parallel communications hierarchy, used only by the MPI version.  For example, '1 10 100' would mean that one director would talk to 10 managers, which would talk to 100 workers (implying that each manager is assigned 10 workers).  Similarly, '1 100' would mean that one manager would talk directly to 100 workers.  Required for the MPI version." );
...
option.add( basic::options::OptionKeys::cyclic_peptide::MPI_sort_by, "The MPI versions of the helical_bundle_predict and simple_cycpep_predict applictions have the option of writing out the top N% of solutions.  This determines the sort metric." ).legal("energy").legal("rmsd").legal("hbonds").def("energy");
option.add( basic::options::OptionKeys::cyclic_peptide::MPI_choose_highest, "When outputing the top N% of solutions, should I choose the ones with the highest score for the metric chosen (energy, rmsd, hbonds, etc.) or lowest?  Default false (chose lowest)." ).def(false);
...
option.add( basic::options::OptionKeys::cyclic_peptide::MPI_stop_after_time, "If this option is used, the director node will send a stop signal after an elapsed period of time, given in seconds.  Worker jobs currently running will continue, but intermediate managers will not assign any more work.  Useful on HPC clusters with time limits, to ensure that jobs completed are collected at the end.  Unused if not specified." );
option.add( basic::options::OptionKeys::cyclic_peptide::MPI_pnear_lambda, "In MPI mode a goodness-of-funnel metric is automatically calculated at the end (PNear).  This value may be thought of as the probability, from 0 to 1, of the peptide being in the native conformation at any given time.  The parameter lambda controls the breadth of the Gaussian (in RMSD units -- Angstroms) that is used to determine the extent to which a state is native-like.  Default 0.5 A." ).def(0.5);
option.add( basic::options::OptionKeys::cyclic_peptide::MPI_pnear_kbt, "In MPI mode a goodness-of-funnel metric is automatically calculated at the end (PNear).  This value may be thought of as the probability, from 0 to 1, of the peptide being in the native conformation at any given time.  The parameter kbt is the Boltzmann temperature that determines the extent to which higher energy states are likely to be sampled.  Default 1.0 kcal/mol." ).def(1.0);
option.add( basic::options::OptionKeys::cyclic_peptide::threads_per_worker, "In the multi-threaded MPI compilation, this is the number of threads to launch per worker process.  (This was formerly called threads_per_slave.)  Note that director and manager-layer processes do not launch threads.  A value of 1 (the default) means that only standard hierarchical process-based parallelism will be used.  In non-MPI or non-threaded compilations, this option is unused." ).def(1);
option.add( basic::options::OptionKeys::cyclic_peptide::compute_rmsd_to_lowest, "If true the RMSD to the top structure (by whatever ranking) is computed in addition to the RMSD to a user-supplied native (if a native structure is provided).  False by default.  Only used in MPI version of Rosetta." ).def(false);
option.add( basic::options::OptionKeys::cyclic_peptide::compute_pnear_to_this_fract, "If this option is provided, PNear will be computed to each of the lowest-energy samples found, for the specified lowest-energy fraction.  (Setting this to 0.02 would compute PNear to each of the lowest-energy 2% of samples, for example).  Not used by default." ).def(0.0);
option.add( basic::options::OptionKeys::cyclic_peptide::compute_ensemble_sasa_metrics, "If true, the Boltzmann-weighted SASA, polar SASA, hydrophobic SASA, and number of unsatisfied polar groups is computed (ensemble average).  False by default.  Only used in MPI version of Rosetta." ).def(false);
...
option.add( basic::options::OptionKeys::ddg::wt_only, "option added to minirosetta app in order to produce only refinement in wt structures" ).def(false);
...
option.add( basic::options::OptionKeys::ddg::optimize_wt, "Will optimize the native structure when using the refactored version of the code. This will serve as the new baseline score." ).def(true);
...
option.add( basic::options::OptionKeys::ddg::rna_all_prot_sc_min_only, "No description" ).def(false);
...
option.add( basic::options::OptionKeys::ddg::iterations, "specifies the number of iterations of refinement" ).def(3);
option.add( basic::options::OptionKeys::ddg::force_iterations, "Forces the ddg protocol to iterate up to the value set by iterations rather than stoping at convergence." ).def(true);
...
option.add( basic::options::OptionKeys::ddg::cst_dist_cutoff, "the cutoff distance for generating harmonic csts between residues" ).def(9.0);
option.add( basic::options::OptionKeys::ddg::cartesian, "Toggle cartesian mode in the CartesianddG app calculations" ).def(true);
option.add( basic::options::OptionKeys::ddg::extract_element_nbrs, "How many sequence space nbrs to extract when doing binding calculations" ).def(0);
option.add( basic::options::OptionKeys::ddg::frag_nbrs, "How many (sequence) neighbors should the fragments include. i.e. 2 nbrs = fragments of size 5 with the target in the middle" ).def(2);
option.add( basic::options::OptionKeys::ddg::bbnbrs, "How many (sequence) neighbors should be included in the backbone minimization" ).def(1);
option.add( basic::options::OptionKeys::ddg::nfrags, "How many fragments to pick, and then use, in the cartesian sampler" ).def(30);
option.add( basic::options::OptionKeys::ddg::ntrials, "How many cycles of frag assign to run in the cartesian sampler" ).def(30);
option.add( basic::options::OptionKeys::ddg::optimize_proline, "Triggers use of fragments and the cartesian sampler to optimize around proline residues." ).def(false);
option.add( basic::options::OptionKeys::ddg::flex_bb, "Should neighbor residues be allowed to move the backbone." ).def(false);
option.add( basic::options::OptionKeys::ddg::fd_mode, "Preserving franks mode for testing directional neighborfinding." ).def(false);
option.add( basic::options::OptionKeys::ddg::legacy, "Call the legacy version of the cartesian_ddg app." ).def(true);
option.add( basic::options::OptionKeys::ddg::json, "Read and write results in json." ).def(false);
option.add( basic::options::OptionKeys::ddg::n_converged, "How many models need to be in range for the solution to be considered converged." ).def(2);
option.add( basic::options::OptionKeys::ddg::score_cutoff, "What is the score cutoff to be considered converged." ).def(1.0);
...
option.add( basic::options::OptionKeys::dna::specificity::exclude_dna_dna, "No description" ).def(false);
...
option.add( basic::options::OptionKeys::dna::specificity::lk_ball_for_bb, "No description" ).def(true);
option.add( basic::options::OptionKeys::dna::specificity::lk_ball_ramp_width_A2, "No description" ).def(3.9);
option.add( basic::options::OptionKeys::dna::specificity::lk_ball_overlap_gap, "No description" ).def(0.0);
...
option.add( basic::options::OptionKeys::dna::specificity::lk_dome_max_angle, "The max angle for the lk_dome. 180 is as high as this can go." ).def(180);
option.add( basic::options::OptionKeys::dna::specificity::lk_dome_min_angle, "The min angle for the lk_dome. 0 is as high as this can go." ).def(104.40720);
option.add( basic::options::OptionKeys::dna::specificity::lk_dome_occlusion_min, "What is the minimum occlusion value below which lk_dome is full power." ).def(3.21592);
option.add( basic::options::OptionKeys::dna::specificity::lk_dome_occlusion_max, "How occluded must the lk_ball water be before lk_dome turns off." ).def(5.09299);
option.add( basic::options::OptionKeys::dna::specificity::lk_dome_h2o_radius, "Radius for lk_dome waters." ).def(1.4);
option.add( basic::options::OptionKeys::dna::specificity::lk_dome_ramp_width_A2, "Width in squared angstroms for fall-off region of lk_dome from water." ).def(3.9);
option.add( basic::options::OptionKeys::dna::specificity::lk_dome_overlap_width_A2, "Width in squared angstroms for the size of the water-water lk_dome interaction." ).def(5.0);
option.add( basic::options::OptionKeys::dna::specificity::lk_dome_ball_overlap_width_A2, "Width in squared angstroms for the size of the water-water lk_ball_bridge2 interaction." ).def(5.0);
option.add( basic::options::OptionKeys::dna::specificity::lk_dome_water_dist, "Distance from lk_ball water to lk_dome water" ).def(2.7436);
option.add( basic::options::OptionKeys::dna::specificity::lk_dome_water_adjust, "Adjustment to lk_ball water distance for lk_dome calcs." ).def(-1.275);
...
option.add( basic::options::OptionKeys::DisulfideInsertion::DisulfideInsertion, "DisulfideInsertion option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::DisulfideInsertion::peptide_chain, "The number of peptide chain for which to perform a DisulfideInsertion check" ).def(1);
option.add( basic::options::OptionKeys::DisulfideInsertion::n_cyd_seqpos, "The sequential position of the residue in the n-ter of the putative disulfide; 0 signals the peptide n-ter" ).def(0.0);
option.add( basic::options::OptionKeys::DisulfideInsertion::c_cyd_seqpos, "The sequential position of the residue in the c-ter of the putative disulfide; 0 signals the peptide c-ter" ).def(0.0);
option.add( basic::options::OptionKeys::DisulfideInsertion::max_dslf_pot, "The maximum allowed match score for disulfide rotation and translation" ).def(2.0);
option.add( basic::options::OptionKeys::DisulfideInsertion::max_dslf_energy, "The maximum allowed change in disulfide energy upon peptide disulfide bridge formation" ).def(-0.5);
option.add( basic::options::OptionKeys::DisulfideInsertion::min_dslf_dist_multiplier, "A multiplier for the minimum allowed distance between residues that might form a disulfide." ).def(1.0);
option.add( basic::options::OptionKeys::DisulfideInsertion::max_dslf_dist_multiplier, "A multiplier for the maximum allowed distance between residues that might form a disulfide." ).def(1.0);
option.add( basic::options::OptionKeys::DisulfideInsertion::scorefxn, "The scorefunction to be used in disulfideInsertion" );
option.add( basic::options::OptionKeys::DisulfideInsertion::constraint_weight, "Weight of the constraints on disulfide bonds formed by the DisulfideInsertionMover; EXPERIMENTAL" ).def(0.0);
...
option.add( basic::options::OptionKeys::docking::docking_low_res_score, "Define low resolution docking score function." ).shortd( "low resolution docking score" ).def("interchain_cen");
...
option.add( basic::options::OptionKeys::docking::SymDock_lowres_filter, "Manually sets the lowres docking filter value that will be multiplied by the number of interfaces" ).shortd( "Manually sets the lowres docking filter" ).def(5.0);
...
inline void add_rosetta_options_8( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::docking::high_patch, "Name of weights patch file (without extension .wts) to use during docking" );
...
option.add( basic::options::OptionKeys::docking::enable_pymol_viewer, "See conformer switch moves in PyMOL. Color changes when switch is accepted." ).shortd( "See conformer switch moves in PyMOL." ).def(false);
option.add( basic::options::OptionKeys::docking::SymDock_reduce_motif_dock_weights, "Reduces motif_dock_score weights to 1/N, where N = number of subunits" ).shortd( "Reduces motif_dock_score weights to proportionally" ).def(false);
option.add( basic::options::OptionKeys::docking::SymDock_fa_rep_max, "Changes the max value of fa_rep for the docking_hires_mover, but not for jd2 score file." ).shortd( "Changes the max value of fa_rep in high-res" ).def(0.55);
option.add( basic::options::OptionKeys::docking::SymDock_fa_sol_max, "Changes the max value of fa_sol for the docking_hires_mover, but not for jd2 score file." ).shortd( "Changes the max value of fa_sol in high-res" ).def(1.0);
...
option.add( basic::options::OptionKeys::docking::ligand::iphold_cen_cycles, "Number of centroid iphold cycles" ).def(0);
option.add( basic::options::OptionKeys::docking::ligand::iphold_fa_cycles, "Number of full-atom iphold cycles" ).def(0);
...
option.add( basic::options::OptionKeys::dump_trajectory::dump_trajectory, "dump_trajectory option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::dump_trajectory::prefix, "Prefix to use when dumping trajectories with dump_trajectory ScoreType." ).def("traj");
option.add( basic::options::OptionKeys::dump_trajectory::gz, "Dump trajectories in .pdb.gz format." ).def(false);
option.add( basic::options::OptionKeys::dump_trajectory::stride, "The stride for trajectory dumping.  This defaults to 1, meaning that a pose is dumped for every function call.  Higher values dump a pose after every Nth function call, allowing sparser sampling of trajectories." ).def(1);
...
option.add( basic::options::OptionKeys::edensity::periodicity, "calculate density scores with periodic boundaries" ).def(true);
...
option.add( basic::options::OptionKeys::epr_deer::epr_deer, "epr_deer option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::epr_deer::input_files, "Input files for DEER distance or decay data" );
option.add( basic::options::OptionKeys::epr_deer::coords_files, "Input files for coordinates used for DEER measurement simulation" );
option.add( basic::options::OptionKeys::epr_deer::print_data, "Prints DEER distance distributions and decay traces. Note that this will flood your terminal if used during Monte Carlo modeling." ).def(false);
...
option.add( basic::options::OptionKeys::flexPepDocking::hb_filter, "Only output decoys with more h-bonds than this filter.  Currently not implemented -- DO NOT USE!" ).shortd( "Only output decoys with more h-bonds than this filter.  Currently not implemented -- DO NOT USE!" ).lower(0).def(0);
option.add( basic::options::OptionKeys::flexPepDocking::hotspot_filter, "Only output decoys with more hotspots than this filter.  Currently not implemented -- DO NOT USE!" ).shortd( "Only output decoys with more hotspots than this filter.  Currently not implemented -- DO NOT USE!" ).lower(0).def(0);
...
inline void add_rosetta_options_9( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::fold_from_loops::add_relax_cycles, "additional relax cycles" ).def(2);
...
option.add( basic::options::OptionKeys::frags::j, "Number of threads to use.  The default, 0, means use all available threads.  Note that total threads must be set with -multithreading:total_threads.  (The fragment picker cannot use more threads than have been launched)." ).def(0);
...
option.add( basic::options::OptionKeys::helical_bundle_predict::helical_bundle_predict, "helical_bundle_predict option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::helical_bundle_predict::sequence_file, "Filename of a file specfying the sequence, as a series of whitespace-separated full residue names (e.g. ALA LYS DARG DPRO HYP).  Required input for the simple_cycpep_predict app unless -in:file:fasta is provided." );
option.add( basic::options::OptionKeys::helical_bundle_predict::helix_assignment_file, "A file containing information about the helix types and helical regions within a helical bundle." ).def("");
option.add( basic::options::OptionKeys::helical_bundle_predict::psipred_file, "A file produced by PsiPred, with columns indicating position, alpha helix probability, beta strand probability, and random coil probability.  An alternative to helix_assignment_file for canonical amino acid predictions." ).def("");
option.add( basic::options::OptionKeys::helical_bundle_predict::psipred_alpha_helix_prob_cutoff, "The probability cutoff above which a position is assigned to be alpha helical when using a PsiPred file.  Default 0.75." ).def(0.75);
option.add( basic::options::OptionKeys::helical_bundle_predict::psipred_beta_strand_prob_cutoff, "The probability cutoff above which a position is assigned to be in a beta strand conformation when using a PsiPred file.  Default 0.75." ).def(0.75);
option.add( basic::options::OptionKeys::helical_bundle_predict::num_simulated_annealing_rounds_centroid, "Number of rounds of simulated annealing in centroid mode." ).def(3);
option.add( basic::options::OptionKeys::helical_bundle_predict::num_steps_per_simulated_annealing_round_centroid, "Number of steps in each round of simulated annealing in centroid mode." ).def(1000);
option.add( basic::options::OptionKeys::helical_bundle_predict::centroid_max_temperature, "The maximum temperature during simulated annealing rounds in centroid mode." ).def(50.0);
option.add( basic::options::OptionKeys::helical_bundle_predict::centroid_min_temperature, "The minimum temperature during simulated annealing rounds in centroid mode." ).def(0.62);
option.add( basic::options::OptionKeys::helical_bundle_predict::do_final_fullatom_refinement, "If true, the initial centroid model is converted to a full-atom model and relaxed with the FastRelax protocol.  Other refinement steps, such as finding disulfides, may also be carried out.  True by default." ).def(true);
option.add( basic::options::OptionKeys::helical_bundle_predict::fast_relax_rounds, "The number of rounds of FastRelax that will be applied.  Does nothing if do_final_fullatom_refinement is false.  Set to 3 by default." ).def(3);
option.add( basic::options::OptionKeys::helical_bundle_predict::find_disulfides, "If true, the full-atom refinement steps include trying disulfide permutations.  Does nothing if do_final_fullatom_refinement is false.  True by default." ).def(true);
option.add( basic::options::OptionKeys::helical_bundle_predict::ignore_native_residues_in_rmsd, "A whitespace-separated list of residues in the pose provided with -in:file:native which should NOT be used in calculating the RMSD.  The alignment will skip these residues.  For example, if the generated structures are 10 residues long, the native is 11, and residue 5 is skipped, then residues 1-4 will be aligned to residues 1-4 of the generated structures, and residues 6-11 of the native wil be aligned to resiudues 5-10 of the generated stuctures." );
option.add( basic::options::OptionKeys::helical_bundle_predict::ignore_prediction_residues_in_rmsd, "A whitespace-separated list of residues in the generated poses that will be ignored when aligning to the pose provided with -in:file:native.  These residues are skipped in the alignment -- so if, for example, residues 3 and 4 are specified, and the generated structures are 12 residues long and the native structure is 10 residues long, residues 1-2 of both structures will be aligned, and residues 5-12 of the generaetd structures will be aligned to residues 3-10 of the native." );
...
option.add( basic::options::OptionKeys::hotspot::batch_size, "Run stub hashing in batches of this size. (Ignored if target_res is set) " ).def(10);
...
option.add( basic::options::OptionKeys::make_rot_lib::output_logging, "If true (the default), then logfiles are written for every mainchain torsion bin attempted.  These can take up a lot of space, so this can be disabled by setting this to false." ).def(true);
...
option.add( basic::options::OptionKeys::make_rot_lib::three_fold_symmetry_90_210_330, "the chi number at which to apply three fold symmetry across the 0/180 axis" );
...
option.add( basic::options::OptionKeys::make_rot_lib::patch_name_for_residue, "Provide an explicit description of the patches for terminal capping" );
option.add( basic::options::OptionKeys::make_rot_lib::polymeric_context, "A file containing the RT at PDB number 0 and the flanking context as well." );
option.add( basic::options::OptionKeys::make_mainchain_potential::make_mainchain_potential, "make_mainchain_potential option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::make_mainchain_potential::do_minimization, "If true, each side-chain rotamer is minimized using the Rosetta molecular mechanics forcefield prior to scoring.  True by default." ).def(true);
option.add( basic::options::OptionKeys::make_mainchain_potential::mainchain_potential_points_per_dimension, "The number of points for each dimension in the multidimensional mainchain potential, provided as a whitespace-separated list of integers.  Each integer must be strictly positive.  Required input." );
option.add( basic::options::OptionKeys::make_mainchain_potential::mainchain_torsions_covered, "The mainchain torsions that are covered by this potential.  For example, an oligourea has four mainchain torsions, but only torsions 1, 2, and 3 are covered (and the fourth is restrained by the omega scoreterm), in which case this option can be set to 1 2 3.  If not specified, it defaults to all mainchain torsions." );
option.add( basic::options::OptionKeys::make_mainchain_potential::make_pre_proline_potential, "If true, then this application will make a potential for a position preceding a proline, sarcosine, peptoid, or other N-substituted building-block.  If false (the default), then it generates a potential for a position preceding an unsubstituted position (e.g. the 19 canonical amino acids other than proline)." ).def(false);
option.add( basic::options::OptionKeys::make_mainchain_potential::output_filename, "Output file to which the generated mainchain potential will be written.  Defaults to generated_mainchain_potential.txt" ).def("generated_mainchain_potential.txt");
option.add( basic::options::OptionKeys::make_mainchain_potential::residue_name, "The name of the residue type for which we will be generating a mainchain potential.  Defaults to ALA if not set, but should be set by the user." ).def("ALA");
option.add( basic::options::OptionKeys::make_mainchain_potential::symmetrize_output, "If true, the output will be made symmetric.  False by default.  Note that this necessitates a five degree offset." ).def(false);
option.add( basic::options::OptionKeys::make_mainchain_potential::write_potentials_for_individual_scoreterms, "If true, a separate potential file is written for each scoreterm.  This is used to fit the weights for the molecular mechanics forcefield used by the make_mainchain_potential application.  Note that these tables will be written unnormalized and with weights of 1.0 for each term.  False by default." ).def(false);
...
inline void add_rosetta_options_10( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::matdes::mutalyze::ala_scan, "Specify whether to calculate ddGs for alanine-scanning mutants at the designed interface" ).def(1);
...
option.add( basic::options::OptionKeys::mean_field::mean_field, "mean_field option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::mean_field::bb_list, "Specifies list of pdb files in backbone ensemble" );
option.add( basic::options::OptionKeys::mean_field::dump_transfac, "filename prefix for dumping the predicted specificity profile in transfac format" ).def("");
option.add( basic::options::OptionKeys::mean_field::spec_profile, "specify filename of specificity profile (PWM) (transfac format).  Used as gold standard to compare to mean-field predicted result." ).def("");
option.add( basic::options::OptionKeys::mean_field::bb_boltz_probs, "specify filename of backbone Boltzmann probabilities.  Can be used in conjunction with bb_list as Boltz probs of backbones in bb_list." ).def("");
option.add( basic::options::OptionKeys::mean_field::rot_norm_weight, "weight rot_norm term" ).def(0.0);
option.add( basic::options::OptionKeys::mean_field::bb_average_weight, "bb_average_weight term" ).def(0.0);
option.add( basic::options::OptionKeys::mean_field::rf_peptide, "specify filename of resfile used for identifying peptide residues (or residues designated for sequence tolerance analysis)" ).def("");
option.add( basic::options::OptionKeys::mean_field::include_all_aa, "upweight probabilities of all amino acids by adding 50 to each value" ).def(false);
option.add( basic::options::OptionKeys::mean_field::ga_pack_detect_interface, "automatically detect protein-peptide interface for calculation of fitness function" ).def(false);
option.add( basic::options::OptionKeys::mean_field::biased_dist_all_gen, "use biased distribution (as specified in spec_profile) for all generations of GA" ).def(false);
...
option.add( basic::options::OptionKeys::motifs::output_build_positions_only, "intended to trigger to only spit out build positions for protein and stop the program if true" ).def(false);
option.add( basic::options::OptionKeys::motifs::specific_build_position, "read in for when collecting relevant motifs per build position, only collect motifs for this build position; intended for long motif lists where it will be best to run motif collection per build position in parallel" ).def(0);
option.add( basic::options::OptionKeys::motifs::verbosity, "Boolean to indicate whether the user wants verbose output on motifs that are rejected in single_ligand_motif_from_stream from motif_utils.cc. This is for the version that does not kill the istream when a bad motif is encountered" ).def(false);
option.add( basic::options::OptionKeys::motifs::params_directory_path, "User-inputted path to a directory where params files are located to be read into a script" ).def(" ");
option.add( basic::options::OptionKeys::motifs::sdf_directory_path, "User-inputted path to a directory where sdf files are located to be read into a script" ).def(" ");
option.add( basic::options::OptionKeys::motifs::mol2_directory_path, "User-inputted path to a directory where mol2 files are located to be read into a script" ).def(" ");
option.add( basic::options::OptionKeys::motifs::mol2_file, "User-inputted name of mol2 file to be converted into a params file. Path to file can be included." ).def(" ");
option.add( basic::options::OptionKeys::motifs::mol2_amino_acid, "set up params file for modified amino acid; .mol2 only; edit chis afterward." );
option.add( basic::options::OptionKeys::motifs::params_custom_file_name, "String to be the name of the output params file (include any extension and pathing in this flag)" );
option.add( basic::options::OptionKeys::motifs::ligand_3_letter_code, "Custom 3 letter code for ligand (will take first 3 letters from mol2 file otherwise)" );
option.add( basic::options::OptionKeys::motifs::ligand_1_letter_code, "Custom 1 letter code for ligand (will take first letter from mol2 file otherwise)" );
option.add( basic::options::OptionKeys::motifs::ligand_full_name, "Custom name of ligand" );
option.add( basic::options::OptionKeys::motifs::write_param_to_pdb, "Bool to use in params file generation script to indicate to make a pdb file of the ligand (to compare to original mol2 and confirm successful translation)" ).def(false);
option.add( basic::options::OptionKeys::motifs::protein_discovery_locus, "Value to indicate the index/locus that a user wants to run ligand discovery for on a protein" ).def(0);
option.add( basic::options::OptionKeys::motifs::fa_rep_cutoff, "Value for ligand discovery cutoff for fa_rep score" ).def(0);
option.add( basic::options::OptionKeys::motifs::fa_atr_cutoff, "Value for ligand discovery cutoff for fa_atr score" ).def(0);
option.add( basic::options::OptionKeys::motifs::output_ligand_pdb, "Optional flag to choose to output read in ligands back out as pdb files. Useful for debugging as well as getting an original ligand in the original placement location for the RMSD calculations" ).def(false);
option.add( basic::options::OptionKeys::motifs::check_new_param_file, "Decide whether to test a generated params file and make sure it was accurately converted (time consumming operation)" ).def(false);
option.add( basic::options::OptionKeys::motifs::ddg_cutoff, "Real value to be used as a cutoff for keeping placed ligands. Optimized placement must be better (smaller) than cutoff. Using very large default value for ease in implementing the filter variable" ).def(1000000);
option.add( basic::options::OptionKeys::motifs::best_pdbs_to_keep, "Size to determine the number of placed ligands to keep and output as pdbs. Default value of 0 indicates to keep any that make it to ddg evaluation (could be a lot)" ).def(0);
option.add( basic::options::OptionKeys::motifs::resolution_scale_factor, "Scale for resolution of holes analysis protocol. Resolution is defaulted to 1 cubic angstrom. This variable is inversely proportional to the linear magnitude of the resolution. I.e. factor = 1 --> resolution = 1A^3 (cube side length = 1/1); factor = 2 --> resolution = 0.125A^3 (cube side length = 1/2) " ).def(1);
option.add( basic::options::OptionKeys::motifs::x_min_holes, "If going to investigate a sub_region of a pdb, this defines the min x value of the region" );
option.add( basic::options::OptionKeys::motifs::x_max_holes, "If going to investigate a sub_region of a pdb, this defines the max x value of the region" );
option.add( basic::options::OptionKeys::motifs::y_min_holes, "If going to investigate a sub_region of a pdb, this defines the min y value of the region" );
option.add( basic::options::OptionKeys::motifs::y_max_holes, "If going to investigate a sub_region of a pdb, this defines the max y value of the region" );
option.add( basic::options::OptionKeys::motifs::z_min_holes, "If going to investigate a sub_region of a pdb, this defines the min z value of the region" );
option.add( basic::options::OptionKeys::motifs::z_max_holes, "If going to investigate a sub_region of a pdb, this defines the max z value of the region" );
option.add( basic::options::OptionKeys::motifs::highresdocker_allow_minimization, "Bool to indicate whether to allow (true) minimization or not (false) in the apply function of HighResDocker" ).def(true);
option.add( basic::options::OptionKeys::motifs::highresdocker_allow_repacking, "Boolean in ligand_docking/HighResDocker to prevent apply function from repacking. Often want value to be true, but this allows option to make it false." ).def(true);
option.add( basic::options::OptionKeys::motifs::highresdocker_use_all_residues, "Boolean in ligand_docking/HighResDocker to determine whether to use all residues in generation of packer_task." ).def(false);
option.add( basic::options::OptionKeys::motifs::ligand_motif_output_directory_name, "Name the directory to which motif pdbs will be outputted to, default of location where script is called. Follow a directory name with a /." ).def("");
option.add( basic::options::OptionKeys::motifs::ligand_motif_output_file_name, "Name the file to which motifs will be outputted to, default of a local directory named AllMattMotifs.motifs. If file type extension not specified (identified as the last period encountered), will output to a file type ending in .motifs" ).def("AllMattMotifs.motifs");
option.add( basic::options::OptionKeys::motifs::output_motifs_as_pdb, "Output generated motifs as pdb files" ).def(true);
option.add( basic::options::OptionKeys::motifs::output_motifs, "Output generated motifs as .motifs file and to a MotifLibrary" ).def(true);
...
option.add( basic::options::OptionKeys::mutate::mutate, "mutate option group" ).legal(true).def(true).is_group(true);

}
inline void add_rosetta_options_11( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::mutate::mutation, "Vector of single mutations: Format: One-letter code / residue number / one-letter code. Example: A163F" );
option.add( basic::options::OptionKeys::mutate::mutant_file, "Input file containing mutations" );
option.add( basic::options::OptionKeys::nmr::nmr, "nmr option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::nmr::pcs::pcs, "pcs option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::nmr::pcs::input_file, "PCS input file." );
option.add( basic::options::OptionKeys::nmr::pcs::nls_repeats, "Number of repeats in non-linear least squares fitting of the PCS tensor." ).lower(1).upper(100).def(5);
option.add( basic::options::OptionKeys::nmr::pcs::optimize_tensor, "Optimize the lanthanide ion position and other parameters of the PCS tensor after grid search." ).def(false);
option.add( basic::options::OptionKeys::nmr::pcs::multiset_weights, "Vector of weights of PCSMultiSets. One PCSMultiSet refers to data collected for multiple lanthanides at one tagging site." ).n_lower(0).n_upper(100);
option.add( basic::options::OptionKeys::nmr::pcs::normalize_data, "Normalize PCS data of every experiment by their standard deviation." ).def(false);
option.add( basic::options::OptionKeys::nmr::pcs::use_symmetry_calc, "Consider the contribution from symmetric subunits for PCS calculation. Only the PCSs of the asymmetric subunit must to be provided as input. The symmetric residues are deduced from the symmetry information carried by the pose. Alternatively, one can provide all residues contributing to one PCS as an ambiguous atom selection in the input file." ).def(false);
option.add( basic::options::OptionKeys::nmr::pcs::show_info, "Show additional information about PCS calculation (experimental vs. back-calculated PCSs and PCS tensor summary) at the end of every ab-initio folding stage." ).def(false);
option.add( basic::options::OptionKeys::nmr::rdc::rdc, "rdc option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::nmr::rdc::input_file, "RDC input file." );
option.add( basic::options::OptionKeys::nmr::rdc::nls_repeats, "Number of repeats in non-linear least squares fitting of the alignment tensor." ).lower(1).upper(100).def(5);
option.add( basic::options::OptionKeys::nmr::rdc::multiset_weights, "Vector of weights of RDCMultiSets. One RDCMultiSet refers data collected for multiple experiments in one alignment medium." ).n_lower(0).n_upper(100);
option.add( basic::options::OptionKeys::nmr::rdc::use_symmetry_calc, "Consider the contribution from symmetric subunits for RDC calculation. Only RDCs of the asymmetric subunit must be provided as input. The symmetric residues are deduced from the symmetry information carried by the pose. This option is still experimental and works so far for cases with C-symmetry and D2-symmetry for which the alignment tensor axes coincide with the symmetry axes." ).def(false);
option.add( basic::options::OptionKeys::nmr::rdc::show_info, "Show additional information about RDC calculation (experimental vs. back-calculated RDCs and alignment tensor summary) at the end of every ab-initio folding stage." ).def(false);
option.add( basic::options::OptionKeys::nmr::rdc::normalization_type, "Apply scaling of input RDC values. Possible options are NH, CH or none. By default RDCs are expected not to be normalized and will be scaled relative to N-H (i.e. option NH). In case of option CH RDCs will be scaled relative to CA-HA. If option none is chosen it is assumed that RDC values have been normalized to H-N before and thus no additional scaling will be applied." ).def("NH");
option.add( basic::options::OptionKeys::nmr::rdc::correct_sign, "Use the correct sign of the 15N gyromagnetic ratio and thus of the dipolar coupling constants i.e. positive for NC and NH and negative for CH. Use this option if input couplings have different signs. By default the 15N gyromagnetic ratio is taken to be positive and the dipolar coupling constants to have the same sign." ).def(false);
option.add( basic::options::OptionKeys::nmr::pre::pre, "pre option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::nmr::pre::input_file, "PRE input file." );
option.add( basic::options::OptionKeys::nmr::pre::nls_repeats, "Number of repeats in non-linear least squares fitting of the spinlabel correlation time." ).lower(1).upper(100).def(3);
option.add( basic::options::OptionKeys::nmr::pre::optimize_para_ion_position, "Optimize the position of the paramagnetic ion. Only in combination with a gridsearch." ).def(false);
option.add( basic::options::OptionKeys::nmr::pre::multiset_weights, "Vector of weights of PREMultiSets. One PREMultiSet refers to multiple datasets collected for the same spinlabel site." ).n_lower(0).n_upper(100);
option.add( basic::options::OptionKeys::nmr::pre::normalize_data, "Normalize PRE data of every experiment by their standard deviation." ).def(false);
option.add( basic::options::OptionKeys::nmr::pre::use_symmetry_calc, "Consider the contribution from symmetric subunits for PRE calculation. Only the PREs of the asymmetric subunit must be provided as input. The symmetric residues are deduced from the symmetry information carried by the pose. Alternatively, one can provide all residues contributing to one PRE as an ambiguous atom selection in the input file." ).def(false);
option.add( basic::options::OptionKeys::nmr::pre::show_info, "Show additional information about PRE calculation (experimental vs. back-calculated PREs and PRE spinlabel summary) at the end of every ab-initio folding stage." ).def(false);
option.add( basic::options::OptionKeys::nmr::spinlabel::spinlabel, "spinlabel option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::nmr::spinlabel::max_ensemble_size, "Maximum number of spinlabel rotamers that make up the ensemble. If the ensemble size is higher, rotamers are binned to speed up the calculation." ).def(20);
option.add( basic::options::OptionKeys::nmr::spinlabel::highres_conformer_filter_type, "Type of filtering spinlabel conformers in Rosetta full-atom mode. Possible modes are: DISTANCE and BUMP_ENERGY. Default is BUMP_ENERGY in which case conformers are checked for clashes by their packer energy. The DISTANCE filter detects clashes by measuring the distance of spin-label side-chain heavy atoms to the NBR_ATOM of neighborhood residues." ).def("BUMP_ENERGY");
option.add( basic::options::OptionKeys::nmr::spinlabel::elaborate_rotamer_clash_check, "If true, perform an elaborate clash check of every heavy atom of all spinlabel rotamers with the atoms in the surrounding amino acid residues. If all rotamers produce at least one clash, return that rotamer with the lowest number of clashes. If false, consider only heavy atoms in non-clashing rotamers and return a random member in case their are no non-clashing rotamers." ).def(false);
option.add( basic::options::OptionKeys::nmr::spinlabel::boltzmann_kt, "Scaling factor for Boltzmann weighting of the spinlabel rotamer probabilities." ).def(2.0);
option.add( basic::options::OptionKeys::nmr::score::score, "score option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::nmr::score::verbose, "Write separate score values and Q-factors for each spinlabel site, alignment medium and/or lanthanide ion to the scorefile." ).def(false);
option.add( basic::options::OptionKeys::nmr::score::output_exp_calc, "Write a table of experimental vs. calculated NMR values for each NMR dataset to prediction file." ).def(false);
option.add( basic::options::OptionKeys::nmr::score::output_tensor_info, "Write tensor and/or spinlabel info for each NMR dataset to info file." ).def(false);
...
option.add( basic::options::OptionKeys::optE::include_intra_res_protein, "Instruct the IterativeOptEDriver to turn on intra-residue interactions (needed for BetaNov15 score function)" ).def(false);
...
option.add( basic::options::OptionKeys::optE::design_with_minpack, "Use the min-packer to design during the sequence recovery stages." ).def(false);
option.add( basic::options::OptionKeys::optE::design_with_fast_design, "Use FastDesign to design during the sequence recovery stages." ).def(false);
option.add( basic::options::OptionKeys::optE::design_with_offrotpack, "Use the off-rotamer-packer to design during the sequence recovery stages." ).def(false);
...
option.add( basic::options::OptionKeys::pocket_grid::pocket_num_angles, "Number of different pose angles to measure pocket score at" ).def(100);
...
inline void add_rosetta_options_12( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::fingerprint::esp_protein_wt, "add weight for electrostatic energy inside protein" ).def(0);
...
option.add( basic::options::OptionKeys::qsar::max_grid_cache_size, "delete old grids if grid cache exceeds specified size" ).def(10);
...
option.add( basic::options::OptionKeys::hydrate::hydrate, "hydrate option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::hydrate::hyfile, "This file defines which residues to hydrate; add waters de novo around their polar atoms." );
option.add( basic::options::OptionKeys::hydrate::hydrate_all, "Add de novo water molecules to the entire structure, not compatible with design." ).def(false);
option.add( basic::options::OptionKeys::hydrate::ignore_fa_sol_at_positions, "Set all implicit solvation contributions to zero when involving the position numbers in the given IntegerVector." ).def();
option.add( basic::options::OptionKeys::hydrate::attempt_all_polar, "Attempt to hydrate all polar atoms regardless of them having room or not." ).def(false);
option.add( basic::options::OptionKeys::hydrate::partial_hydrate_dew, "During the first round of packing when using double edge water (dew) molecules, only this fraction of de novo waters will be considered." ).def(0.75);
option.add( basic::options::OptionKeys::hydrate::water_energy_threshold, "Water molecules with energy above this threshold will be removed after packing." ).def(5.0);
option.add( basic::options::OptionKeys::hydrate::water_rotamers_cap, "Limits the maximum number of water rotamers." ).def(500);
option.add( basic::options::OptionKeys::hydrate::water_packing_radius, "Defines the radius a water molecule is allowed to explore during packing" ).def(1.0);
option.add( basic::options::OptionKeys::hydrate::water_angular_resolution, "Defines the angular resolution for water rotamers. As a corollary, it also defines the number of rotamers for each water molecule ((2*space_res+1)^3 * 2 * 2*ang_res^2)." ).def(3);
option.add( basic::options::OptionKeys::hydrate::water_space_resolution, "Defines the spacial resolution for water rotamers. As a corollary, it also defines the number of rotamers for each water molecule ((2*space_res+1)^3 * 2 * 2*ang_res^2)." ).def(2);
option.add( basic::options::OptionKeys::hydrate::hbond_threshold, "Hydrogen bond threshold. New water rotamers must make hbond of at least this value." ).def(-0.1);
option.add( basic::options::OptionKeys::hydrate::hbond_entropy_threshold, "Threshold for water hbonds to contribute to entropy." ).def(-0.5);
option.add( basic::options::OptionKeys::hydrate::water_desolvation, "Desolvation energy of a water molecule. Energy difference between a molecule in bulk water and near a protein. This value will be scaled by the scoring function weight for wat_desolv" ).def(4.8);
option.add( basic::options::OptionKeys::hydrate::pack_nloop, "How many times to repack" ).def(25);
option.add( basic::options::OptionKeys::hydrate::pre_bump_check, "Do bump check before store them in memory" ).def(true);
option.add( basic::options::OptionKeys::hydrate::bias_design_search_to_native, "It gives an artificially large negative energy to any native rotamer during packing. It was implemented to test the use of design waters." ).def(false);
option.add( basic::options::OptionKeys::hydrate::waters_per_ion, "Number of de novo waters to add per metal ion (default: 0)." ).def(0);
option.add( basic::options::OptionKeys::hydrate::no_inside_check_for_water_rotamers, "Debug option to not filter non-inside water rotamers, useful for hydrating non-protein systems -- WARNING: large memory when many hydrateable atoms/residues (default: false)." ).def(false);
option.add( basic::options::OptionKeys::hydrate::show_derivatives_check, "Show derivatives check when minimizing in the hydrate protocol." ).def(false);
option.add( basic::options::OptionKeys::hydrate::keep_non_buried_waters, "Keep non buried waters in the final structure (not recommended)." ).def(false);
option.add( basic::options::OptionKeys::hydrate::display_water_hb_network, "Shows the water hydrogen bonds connections." ).def(true);
option.add( basic::options::OptionKeys::hydrate::show_pre_post_filter_water_rotamers, "Shows the exigen location of the post and pre filtered water rotamers." ).def(false);
option.add( basic::options::OptionKeys::hydrate::show_pre_filtered_water_rotamers_count, "Shows the total number of pre-filtered water rotamers; Helps assessing the memory requirements." ).def(false);
option.add( basic::options::OptionKeys::hydrate::show_residues_near_water, "Print out the residues that are near hydratable water after water packing and placement." ).def(false);
option.add( basic::options::OptionKeys::hydrate::only_remove_non_buried_waters, "Remove non-buried waters from input, then exit." ).def(false);
option.add( basic::options::OptionKeys::hydrate::just_score, "Just score the input structures with the hybrid solvation protocol." ).def(false);
option.add( basic::options::OptionKeys::hydrate::show_rotamer_count, "Output the rotamer counts for each water and amino acid, then exit." ).def(false);
option.add( basic::options::OptionKeys::hydrate::remove_de_novo_waters, "Remove de novo waters from pose/PDB at the end of RemoveWaters protocol." ).def(false);
option.add( basic::options::OptionKeys::hydrate::remove_far_away_waters, "Remove far away waters from pose/PDB at the end of RemoveWaters protocol." ).def(false);
option.add( basic::options::OptionKeys::hydrate::remove_non_buried_waters, "Remove non buried waters from pose/PDB at the end of RemoveWaters protocol." ).def(false);
option.add( basic::options::OptionKeys::hydrate::protein_flexibility, "Defines the protein flexibility during the run" ).legal("not").legal("all").legal("resfile").legal("near_water").def("not");
option.add( basic::options::OptionKeys::hydrate::near_water_threshold, "Threshold for res to be considered flexible when using the near_water option in -hydrate:protein_flexibility" ).def(4.0);
option.add( basic::options::OptionKeys::hydrate::minimize_bb_where_packing, "Allow backbone to move when minimizing." ).def(false);
option.add( basic::options::OptionKeys::hydrate::dont_hydrate_hb_engaged_bb_O, "Avoid hydrating hydrogen bond engaged backbone oxygens, even if it is just one hb. The purpose is to avoid disrupting atable structures (helices and sheets)." ).def(true);
option.add( basic::options::OptionKeys::hydrate::short_residence_time_mode, "A faster mode to capture short residence time water molecules. Not good for energy predictions, and the results are better analyzed as an ensamble rather than a single structure." ).def(false);
option.add( basic::options::OptionKeys::hydrate::min_backbone_file, "This file defines whether the backbone is allowed to move for a specific residue." );
option.add( basic::options::OptionKeys::hydrate::single_away_rotamer, "Use single away water rotamer. The sampling gets biased towards keeping more water present." ).def(false);
option.add( basic::options::OptionKeys::hydrate::force_enforce_all_waters, "Keep water molecules enforced throughout hybrid solvation protocol." ).def(false);
...
option.add( basic::options::OptionKeys::relax::use_explicit_water, "Consider explicit waters (part of the hybrid solvation protocol) during relax" ).def(false);
option.add( basic::options::OptionKeys::relax::movemap_disables_packing_of_fixed_chi_positions, "If true, positions for which the movemap prevents sidechain minimization will also have packing disabled.  False by default." ).def(false);
...
option.add( basic::options::OptionKeys::remodel::staged_sampling::loop_9mer_score_file, "stage1_score" );
option.add( basic::options::OptionKeys::remodel::staged_sampling::loop_3mer_score_file, "stage2_score" );
option.add( basic::options::OptionKeys::remodel::staged_sampling::all_9mer_score_file, "stage3_score" );
option.add( basic::options::OptionKeys::remodel::staged_sampling::all_3mer_score_file, "stage4_score" );
option.add( basic::options::OptionKeys::remodel::staged_sampling::loop_9mer_cycles, "stage1_cycles" );
option.add( basic::options::OptionKeys::remodel::staged_sampling::loop_3mer_cycles, "stage2_cycles" );
option.add( basic::options::OptionKeys::remodel::staged_sampling::all_9mer_cycles, "stage3_cycles" );
option.add( basic::options::OptionKeys::remodel::staged_sampling::all_3mer_cycles, "stage4_cycles" );
...
inline void add_rosetta_options_13( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::resample::stage2, "if true restart after stage1, otherwise after stage2 " ).def(false);
...
option.add( basic::options::OptionKeys::rna::denovo::denovo, "denovo option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::rna::denovo::cycles, "Default number of Monte Carlo cycles" ).def(0);
option.add( basic::options::OptionKeys::rna::denovo::rna_protein_docking_freq, "RNA/protein docking frequency (between 0 (no docking) and 1 (all docking))" ).def(0.4);
option.add( basic::options::OptionKeys::rna::denovo::rounds, "Number of rounds to split cycles into during fragment assembly" ).def(10);
option.add( basic::options::OptionKeys::rna::denovo::temperature, "temperature" ).def(2.0);
option.add( basic::options::OptionKeys::rna::denovo::minimize_rna, "Minimize RNA after fragment assembly" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::sequence, "RNA sequence to model (better to supply in -fasta)" ).def();
option.add( basic::options::OptionKeys::rna::denovo::secstruct, "RNA sec struct to model (better to supply in -secstruct_file)" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::secstruct_general, "RNA sec struct to model with possible noncanonical pairs" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::secstruct_file, "RNA sec struct to model in dot-parens notation" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::secstruct_general_file, "RNA sec struct (+non-canonical pairs) to model in dot-parens notation" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::secstruct_legacy, "RNA sec struct in old 1D notation: H,helix; L,loop; X,unknown; N,bulge" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::lores_scorefxn, "Low resolution scorefunction weights file" ).def("farna/rna_lores.wts");
option.add( basic::options::OptionKeys::rna::denovo::set_lores_weights, "Modification to lores scorefxnweights via the command line. Applied in ScoreFunctionFactory::create_score_function inside the function apply_user_defined_reweighting_. Format is a list of paired strings: -set_lores_weights <score_type1> <setting1> <score_type2> <setting2> ..." ).def();
option.add( basic::options::OptionKeys::rna::denovo::symm_hack_arity, "For hacky symmetry that forces matching fragment insertions, what's the n-repeats?" ).def(1);
option.add( basic::options::OptionKeys::rna::denovo::exhaustive_fragment_insertion, "Instead of doing a single random fragment insertion per move, do the BEST one from among n random trials." ).def(1);
option.add( basic::options::OptionKeys::rna::denovo::filter_lores_base_pairs, "Filter for models that satisfy structure parameters" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::filter_lores_base_pairs_early, "Filter for models that satisfy structure parameters at round 2 of 10" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::filter_chain_closure, "Filter for models that have closed chains after lores before minimize" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::filter_chain_closure_halfway, "Filter for models that have closed chains after lores before minimize at round 5 of 10" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::filter_chain_closure_distance, "Mean distance across 3 chainbreak atoms to filter models that have closed chains after lores" ).def(6.0);
option.add( basic::options::OptionKeys::rna::denovo::relax_rna, "Relax RNA after fragment assembly" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::simple_relax, "Relax by minimizing after any fragment insertion" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::ignore_secstruct, "Ignore sec struct in input file" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::jump_change_frequency, "jump change frequency" ).def(0.1);
option.add( basic::options::OptionKeys::rna::denovo::close_loops, "close loops after de novo protocol and again after minimization" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::close_loops_after_each_move, "close loops during frag insertion and jump mover -- can be expensive" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::heat, "Heat (random frag insertions)" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::staged_constraints, "Apply constraints in stages depending on sequence separation" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::jump_library_file, "Input file for jumps" ).def("RNA18_HUB_2.154_2.5.jump");
option.add( basic::options::OptionKeys::rna::denovo::vall_torsions, "Torsions file containing information on fragments from RNA models" ).def("RNA18_HUB_2.154_2.5.torsions");
option.add( basic::options::OptionKeys::rna::denovo::use_1jj2_torsions, "Use original (ribosome) fragments, 1JJ2" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::fuzz_fragments, "When picking fragments, fuzz fragments with multiple samples with Gaussians of this standard deviation" ).def(0);
option.add( basic::options::OptionKeys::rna::denovo::rna_lores_chainbreak_weight, "chainbreak weight for lo res sampling" ).def(0.0);
option.add( basic::options::OptionKeys::rna::denovo::rna_lores_linear_chainbreak_weight, "linear chainbreak weight for lo res sampling" ).def(0.0);
option.add( basic::options::OptionKeys::rna::denovo::fixed_stems, "Seed each stem with a Watson-Crick base pair instead of having the strands find each other" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::allow_bulge, "Automatically virtualize residues that are not energetically stable" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::allowed_bulge_res, "Use with allow_bulge, allowable pos for virtualization" ).def();
option.add( basic::options::OptionKeys::rna::denovo::allow_consecutive_bulges, "allow_consecutive_bulges" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::move_first_rigid_body, "first_rigid_body is usually kept frozen, but might be useful to sample it." ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::root_at_first_rigid_body, "places coordinate system away from the usual last virtual residue and puts it on the first rigid body. useful if this rigidbody needs to be fixed, but other bodies need to move as if this one is moving. Use with -move_first_rigid_body. " ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::dock_each_chunk, "Dock each chunk, set fold tree up so that there are jumps from root virtual residue to all chunks, very useful for optimizing positions in density, use with -new_fold_tree_initializer" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::dock_each_chunk_per_chain, "Dock each chunk, including multiple chunks from the same chain, set fold tree up so that there are jumps from root virtual residue to all chunks, very useful for optimizing positions in density, use with -dock_each_chunk and -new_fold_tree_initializer, may also want to use with -initial_structures" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::dock_chunks, "Chunks that should be explicitly docked (the fold tree will be set up so that there are jumps from the root virtual residue to each of these chunks), use with -new_fold_tree_initializer" ).def("true");
option.add( basic::options::OptionKeys::rna::denovo::center_jumps_in_single_stranded, "For RNA chains that don't have any base pairs, set up jumps in the center rather than at the first residue in the chain, use with -new_fold_tree_initializer and -dock_each_chunk" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::initial_structures, "Initial structure for fragment assembly, useful for initializing rigid body orientations for docking especially with density" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::ft_close_chains, "Default is true (but it's only used if -initial_structures is also specified). May set to false with -initial_structures and either -dock_each_chunk_per_chain or -dock_chunks (and then you must include all concantenated sub-chunks from -initial_structures)." ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::helical_substructs, "Files provided with -s or -in:file:silent that represent helices, use with dock_each_chunk_per_chain and -new_fold_tree_initializer, includes moves that rotate and translate these helices along their helical axis" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::suppress_bp_constraint, "Factor by which to lower base pair constraint weight. " ).def(1.0);
option.add( basic::options::OptionKeys::rna::denovo::output_filters, "output lores scores at early stage (round  2 of 10) and at end -- could be useable for early termination of unpromising early starts" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::autofilter, "Automatically skip output/minimize if lores score is worse than 20th percentile, updated on the fly." ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::no_filters, "Turn off filters in FARFAR. (umbrella flag) -autofilter false -filter_lores_base_pairs false -filter_lores_base_pairs_early false -filter_chain_closure false -filter_chain_closure_halfway false -filter_chain_closure_distance false" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::output_res_num, "Numbering (and chain) of residues in output PDB or silent file" ).def();
option.add( basic::options::OptionKeys::rna::denovo::offset, "Numbering offset for output PDB or silent file (better to use -output_res_num))" ).def(0);
option.add( basic::options::OptionKeys::rna::denovo::input_silent_res, "Input residues for silent files" ).def();
option.add( basic::options::OptionKeys::rna::denovo::virtual_anchor, "In rigid body movements, which residues in each body are rotation centers" ).def();
option.add( basic::options::OptionKeys::rna::denovo::obligate_pair, "Residue pairs that must form a base pair (possibly non canonical)" ).def();
option.add( basic::options::OptionKeys::rna::denovo::obligate_pair_explicit, "Residue pairs that must form a base pair, with specification of base edges (W/H/S/X) and orientation (A/P/X or C/T/X)" ).def();
option.add( basic::options::OptionKeys::rna::denovo::chain_connection, "Give SET1 ... and SET2 ... to define segments forming at least one base pair" ).def();
option.add( basic::options::OptionKeys::rna::denovo::remove_pair, "Residue pairs to remove from secondary structure" ).def();
option.add( basic::options::OptionKeys::rna::denovo::remove_obligate_pair, "Residue pairs to remove from obligate pair list" ).def();
option.add( basic::options::OptionKeys::rna::denovo::refine_silent_file, "Name of the silent file to be refined." ).def("");
option.add( basic::options::OptionKeys::rna::denovo::refine_silent_tags, "Tags of structures from the silent file to be refined." ).def();
option.add( basic::options::OptionKeys::rna::denovo::refine_silent_number_of_poses, "Number of low scoring poses to refine from the refine_silent_file" ).def(0);
option.add( basic::options::OptionKeys::rna::denovo::get_fold_tree_from_silent_file, "Use the fold tree specified in a silent file" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::fold_tree_from_silent_file_tag, "Tag of the structure in the get_fold_tree_from_silent_file to use" ).def();
option.add( basic::options::OptionKeys::rna::denovo::refine_native_get_good_FT, "Get a reasonable fold tree when refining native - especially important if some stuff shold stay fixed" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::refine_native, "Refine starting from the native pose" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::override_refine_pose_rounds, "Override rounds/other run parameters that get set if refining pose" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::bps_moves, "Base pair step moves" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::disallow_bps_at_extra_min_res, "Disallow base pair step moves inside input domains, even extra_min_res" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::allow_fragment_moves_in_bps, "Allow fragment/jump moves in regions claimed by base pair steps" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::frag_size, "Force specific fragment size rather than staged from 3 to 2 to 1" ).def(0);
option.add( basic::options::OptionKeys::rna::denovo::VDW_rep_screen_include_sidechains, "Include side chains in the VDW rep screen, use with -VDW_rep_screen_info" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::gradual_constraints, "Gradually turn on the atom_pair_constraints and coordinate_constraints?" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::ramp_rnp_vdw, "Gradually turn on rnp_vdw?" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::grid_vdw_weight, "Weight for the grid vdw score term" ).def(1.0);
option.add( basic::options::OptionKeys::rna::denovo::tag, "tag for naming silent file; legacy of rna_denovo_setup.py" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::working_native, "Native to use if we only know a fragment" ).def("false");
option.add( basic::options::OptionKeys::rna::denovo::use_legacy_setup, "Use old de novo setup without residue/chain mapping" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::cst_gap, "Setup up atompair constraints to keep chain ends close if they are known to be part of the same chain in full model pose" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::convert_protein_CEN, "Convert protein residues to centroid mode during low-res fragment assembly" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::rna_protein_docking, "Do RNA/protein docking?" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::small_docking_moves, "Use small translation and rotation perturbation magnitudes" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::docking_move_size, "Size of docking moves, between 0.0 and 1.0, 1.0 is normal docking move sizes, 0.0 is smallest docking moves" ).def(1.0);
option.add( basic::options::OptionKeys::rna::denovo::rna_protein_docking_legacy, "Do RNA/protein docking, legacy style?" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::rnp_high_res_relax, "Do additional high res relaxation/refinement stage for RNPs" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::rnp_high_res_cycles, "Number of RNP high res refinement cycles to do" ).def(10);
option.add( basic::options::OptionKeys::rna::denovo::rnp_pack_first, "Pack protein sidechains first in RNP high res mover" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::rnp_min_first, "Minimize the structure before RNP high res mover is applied" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::rnp_ramp_rep, "Ramp fa_rep in RNP high res mover" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::new_fold_tree_initializer, "Use the new fold tree initializer framework" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::randomize_init_rnp, "Randomize the initial rigid body position and orientation of the RNA relative to proteins" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::dock_into_density, "Do rigid body transforms to dock the pose into the density?" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::dock_into_density_legacy, "Do rigid body transforms to dock the pose into the density legacy style?" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::exclude_fragments, "Exclude these fragments from vall" ).def();
option.add( basic::options::OptionKeys::rna::denovo::exclusion_match_type, "How tightly should we match fragments? Either sequence-independent (MATCH_ALL), purine vs. pyrimidine (MATCH_YR), or exact (MATCH_EXACT)" ).def("MATCH_EXACT");
option.add( basic::options::OptionKeys::rna::denovo::fragment_homology_rmsd, "Distance in RMSD below which a fragment is considered homologous to the native" ).def(1.0);
option.add( basic::options::OptionKeys::rna::denovo::exclude_native_fragments, "Exclude fragments from -in:file:native" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::exclude_fragment_files, "Files from which to exclude fragments" ).def();
option.add( basic::options::OptionKeys::rna::denovo::dump_stems, "Dump initial stem assignment" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::out::out, "out option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::rna::denovo::out::output_lores_silent_file, "output lores stuff" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::out::dump, "Dump pdb" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::out::binary_output, "force output to binary rna silentstruct" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::out::output_score_file, "output running score to this file [specify 'none' if no score output; .SCORES.txt in default]" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::out::output_score_frequency, "output running score with this frequency [0 means no running output]" ).def(0);
option.add( basic::options::OptionKeys::rna::denovo::out::output_jump_res, "output jump information for these two residues" ).def();
option.add( basic::options::OptionKeys::rna::denovo::out::output_jump_o3p_to_o5p, "compute jump from o3' to o5' (instead of base centroid coordinate systems)" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::out::output_jump_chainbreak, "compute jump from lower chainbreak triad to upper chainbreak triad; perfect overlapwill be (Vector(0.0), identity matrix). " ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::out::output_rotation_vector, "output rotation information as rotation vector (in degrees), not euler angles" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::out::output_jump_reference_RT, "output jump information relative to this rigid body transformation [if empty provided, code will error out but give reference RT for -native or -align_pdb]" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::out::target_xyz, "Target coordinates for harmonic penalty, o5' relative to o3' stub" ).def();
option.add( basic::options::OptionKeys::rna::denovo::out::save_jump_histogram, "Save jump information into a 6D histogram" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::out::output_histogram_file, "output histogram to this file [specify 'none' if no score output; .HISTOGRAM.txt is default]" ).def("");
option.add( basic::options::OptionKeys::rna::denovo::out::jump_histogram_boxsize, "Boxsize (max +/-x,y,z), Angstroms" ).def(40.0);
option.add( basic::options::OptionKeys::rna::denovo::out::jump_histogram_binwidth, "Bin-width for x,y,z,, Angstroms" ).def(4.0);
option.add( basic::options::OptionKeys::rna::denovo::out::jump_histogram_binwidth_rotvector, "Bin-width for rotation vector (degrees)" ).def(36.0);
option.add( basic::options::OptionKeys::rna::denovo::db::db, "db option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::rna::denovo::db::jump_database, "Generate a database of jumps extracted from base pairings from a big RNA file" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::db::bps_database, "Generate a database of base pair steps extracted from a big RNA file" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::minimize::minimize, "minimize option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::rna::denovo::minimize::minimize_rounds, "The number of rounds of minimization." ).def(2);
option.add( basic::options::OptionKeys::rna::denovo::minimize::skip_coord_constraints, "Skip first stage of minimize with coordinate constraints" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::minimize::skip_o2prime_trials, "No O2* packing in minimizer" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::minimize::deriv_check, "In rna_minimize, check derivatives numerically" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::minimize::minimizer_use_coordinate_constraints, "Use coordinate constraints for first round of minimizer" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::minimize::min_type, "Minimizer type" ).def("lbfgs_armijo_nonmonotone");
option.add( basic::options::OptionKeys::rna::denovo::minimize::minimize_bps, "Minimize base pair steps (from Rosetta library)" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::minimize::minimize_all_protein, "Minimize protein residues?" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::minimize::minimize_protein_sc, "Minimize protein sidechains?" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::minimize::protein_packing, "Pack protein residues?" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::minimize::protein_pack_all, "Pack all protein residues?" ).def(false);
option.add( basic::options::OptionKeys::rna::denovo::minimize::protein_packing_distance, "Pack protein residues within this distance of RNA" ).def(10.0);
option.add( basic::options::OptionKeys::rna::denovo::minimize::extra_minimize_res, "Extra residues during minimize step" ).def();
option.add( basic::options::OptionKeys::rna::denovo::minimize::extra_minimize_chi_res, "Extra side-chain chis to move during minimize step" ).def();
option.add( basic::options::OptionKeys::rna::denovo::minimize::minimize_use_nblist, "Use neighbor list during minimization)" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::minimize::minimize_nblist_auto_update, "Auto-update neighbor list during minimization)" ).def(true);
option.add( basic::options::OptionKeys::rna::denovo::minimize::minimize_max_iter, "Maximum number of iterations in minimizer" ).def(2000);
option.add( basic::options::OptionKeys::rna::erraser::erraser, "erraser option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::rna::erraser::rna_prot_erraser, "Allows rna_prot_erraser residue type set, featuring both RNA and protein (for ERRASER purposes).  You must also use -rna:corrected_geo." ).def(false);
option.add( basic::options::OptionKeys::rna::erraser::constrain_P, "constrain phosphate" ).def(false);
option.add( basic::options::OptionKeys::rna::erraser::fixed_res, "optional: residues to be held fixed in minimizer" ).def();
option.add( basic::options::OptionKeys::rna::erraser::ready_set_only, "load in and output directly for reformatting the pdb" ).def(false);
option.add( basic::options::OptionKeys::rna::erraser::skip_minimize, "output the pdb without minimization" ).def(false);
option.add( basic::options::OptionKeys::rna::erraser::attempt_pyrimidine_flip, "try to flip pyrimidine by 180 degrees and pick the better energy conformer" ).def(false);
...
option.add( basic::options::OptionKeys::legacy_sewing::legacy_sewing, "legacy_sewing option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::legacy_sewing::model_file_name, "Filename for model file (creation or reading)" );
option.add( basic::options::OptionKeys::legacy_sewing::score_file_name, "Filename for scores file (creation or reading)" );
option.add( basic::options::OptionKeys::legacy_sewing::new_model_file_name, "Filename for new model file to be written" );
option.add( basic::options::OptionKeys::legacy_sewing::remove_any_dssp, "If a given model has *any* segments with this DSSP, remove it" ).def("");
option.add( basic::options::OptionKeys::legacy_sewing::remove_all_dssp, "If a given model has *all* non-loop segments with this DSSP, remove it" ).def("");
option.add( basic::options::OptionKeys::legacy_sewing::min_helix_length, "Helices less than supplied length will be removed from model file" ).def(0);
option.add( basic::options::OptionKeys::legacy_sewing::max_helix_length, "Helices greater than supplied length will be removed from model file" ).def(1000);
option.add( basic::options::OptionKeys::legacy_sewing::min_loop_length, "Loops less than supplied length will be removed from model file" ).def(0);
option.add( basic::options::OptionKeys::legacy_sewing::max_loop_length, "Loops greater than supplied length will be removed from model file" ).def(1000);
option.add( basic::options::OptionKeys::legacy_sewing::min_strand_length, "Strands less than supplied length will be removed from model file" ).def(0);
option.add( basic::options::OptionKeys::legacy_sewing::max_strand_length, "Strands greater than supplied length will be removed from model file" ).def(1000);
option.add( basic::options::OptionKeys::legacy_sewing::leave_models_by_ss_num, "Only models with certain number of secondary structures remain" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::model_should_have_this_num_of_ss, "Only models with this number of secondary structures remain" );
option.add( basic::options::OptionKeys::legacy_sewing::model_should_have_at_least_1_E_at_terminal_segment, "model_should_have_at_least_one_E_at_terminal_segment" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::model_should_have_at_least_1_E, "model_should_have_at_least_one_E" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::model_should_have_at_least_1_H, "model_should_have_at_least_one_H" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::leave_models_with_E_terminal_ss, "leave only models_with_E_terminal_ss" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::leave_models_with_H_terminal_ss, "leave only models_with_H_terminal_ss" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::leave_antiparallel_way_H_bonded_models_by_terminal_strands, "leave only anti-pa H_bonded_models by_terminal_strands" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::leave_parallel_way_H_bonded_models_by_terminal_strands, "leave only pa H_bonded_models by_terminal_strands" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::leave_certain_model_ids, "Only models with selected ids are left" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::leave_these_model_ids, "Only models with selected ids are left" );
option.add( basic::options::OptionKeys::legacy_sewing::box_length, "Neighborhood lookup box size, 3 for 27 boxes, 4 for 64 boxes etc" ).def(3);
option.add( basic::options::OptionKeys::legacy_sewing::mode, "The mode sewing_hasher should run." ).legal("hash").legal("generate").legal("generate_five_ss_model").legal("convert").legal("test").def("hash");
option.add( basic::options::OptionKeys::legacy_sewing::disregard_num_segment_matches, "if true, disregard num_segment_matches" );
option.add( basic::options::OptionKeys::legacy_sewing::do_not_remove_connection_inconsistencies, "if true, do not remove_connection_inconsistencies" );
option.add( basic::options::OptionKeys::legacy_sewing::score_between_opposite_terminal_segments, "if true, score_between_opposite_terminal_segments like 1-5 or 5-1" ).def(true);
option.add( basic::options::OptionKeys::legacy_sewing::num_models_to_dump, "Used for ModelDumper. How many random models should be dumped?" );
option.add( basic::options::OptionKeys::legacy_sewing::models_to_dump, "Used for ModelDumper for specifying model ids you want to dump" );
option.add( basic::options::OptionKeys::legacy_sewing::min_hash_score, "Minimum number of overlapping atoms per segment" ).def(10);
option.add( basic::options::OptionKeys::legacy_sewing::max_clash_score, "Maximum number of atoms found in the same bin, but not from superimposed fragments" ).def(0);
option.add( basic::options::OptionKeys::legacy_sewing::num_segments_to_match, "Number of segments required to have min_hash_score atom matches" ).def(1);
option.add( basic::options::OptionKeys::legacy_sewing::match_segments, "Segment scored by the hasher" );
option.add( basic::options::OptionKeys::legacy_sewing::max_models, "Maximum models to hash, for testing purposes only" );
option.add( basic::options::OptionKeys::legacy_sewing::starting_model, "Starting model for hashing" );
option.add( basic::options::OptionKeys::legacy_sewing::num_procs, "Number of processors to split up hashing with" );
option.add( basic::options::OptionKeys::legacy_sewing::rank, "The processor rank for this process" );
option.add( basic::options::OptionKeys::legacy_sewing::hash_tag_only_terminal_Es, "hash_tag_only_terminal_Es" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::assembly_type, "Type of Assembly class to generate" ).def("continuous");
option.add( basic::options::OptionKeys::legacy_sewing::num_edges_to_follow, "Maximum number of edges on graph to follow" );
option.add( basic::options::OptionKeys::legacy_sewing::base_native_bonus, "Weighting term for packing native rotamers" );
option.add( basic::options::OptionKeys::legacy_sewing::neighbor_cutoff, "Cutoff for favoring natives in SEWING refinement. Any residues with fewer neighbors is not favored" );
option.add( basic::options::OptionKeys::legacy_sewing::dump_pdbs, "Dump intermediate PDBs" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::skip_refinement, "Should you refine the final assembly" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::skip_filters, "Should the Assembly be filtered before refinment" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::min_motif_score, "Minimum allowable motif score" ).def(20);
option.add( basic::options::OptionKeys::legacy_sewing::may_add_already_added_model, "may_add_already_added_model" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::offset_bump_dsq, "offset to bump_dsq" ).def(0);
option.add( basic::options::OptionKeys::legacy_sewing::num_repeats, "Number of repeats to print in final structures" ).def(3);
option.add( basic::options::OptionKeys::legacy_sewing::repeat, "Should the AssemblyConstraintsMover treat this as a repeat?" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::pose_segment_starts, "Segment begin indices" );
option.add( basic::options::OptionKeys::legacy_sewing::pose_segment_ends, "Segment end indices" );
option.add( basic::options::OptionKeys::legacy_sewing::keep_source_segments, "Keep the source segments rather than the target segments. For use with append" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::partner_pdb, "A PDB that is not part of the Assembly, but will be used for clash checking" );
option.add( basic::options::OptionKeys::legacy_sewing::keep_model_residues, "A list of residues from the input pose that will not be designed (but are repacked)" );
option.add( basic::options::OptionKeys::legacy_sewing::output_alignments_to_file, "Write alignments of input pose and edge file to an alignment file?" ).def(true);
option.add( basic::options::OptionKeys::legacy_sewing::min_lh_fragments, "Minimium number of LoopHash fragments necessary for each designed loop" ).def(10);
option.add( basic::options::OptionKeys::legacy_sewing::skip_loop_generation, "Should you skip generation of loops" ).def(false);
option.add( basic::options::OptionKeys::legacy_sewing::calcium_motif_score_weight, "Sets weight of motif score variant that promotes packing on both sides of an input model" ).def(0.0);
option.add( basic::options::OptionKeys::legacy_sewing::max_ss_num, "max_ss_num so either 3 (smotif) or 5 (5-ss_models)" ).def(5);
option.add( basic::options::OptionKeys::legacy_sewing::dump_every_model, "dump_every_model" ).def(false);
option.add( basic::options::OptionKeys::sewing::sewing, "sewing option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::sewing::edge_file_name, "Name of SEWING edge file (new format)" );
option.add( basic::options::OptionKeys::sewing::model_file_name, "Filename for segment file (creation or reading) for new SEWING" );
...
option.add( basic::options::OptionKeys::sewing::recursive_depth, "How many layers of edges from the current node to generate? E.g. a recursive depth of 2 would generate edges from the starting model and to all models with edges to that model." ).def(2);
...
option.add( basic::options::OptionKeys::sewing::score_between_opposite_terminal_segments, "if true, score_between_opposite_terminal_segments like 1-5 or 5-1" ).def(true);
...
option.add( basic::options::OptionKeys::stepwise::new_align_pdb, "PDB to align to with the new RNA_AlignmentEnergy." ).def("");
...
option.add( basic::options::OptionKeys::stepwise::superimpose_over_all, "In final superimposition, do not keep any domains fixed, superimpose over everything" ).def(true);
option.add( basic::options::OptionKeys::stepwise::alignment_anchor_res, "Single residue that resides in the single input domain that should be superimposed prior to RMSD calculation" ).def();
...
option.add( basic::options::OptionKeys::stepwise::pack_protein_side_chains, "allow neighboring protein side chains to be packed." ).def(true);
option.add( basic::options::OptionKeys::stepwise::definitely_virtualize, "definitely virtualize these residues (by seqpos)" ).def();
option.add( basic::options::OptionKeys::stepwise::force_moving_res_for_erraser, "For ERRASER resample moves, ENSURE that the appropriate residue is moving" ).def(false);
option.add( basic::options::OptionKeys::stepwise::boltzmann_choice_post_enumerated_minimize, "When enumerating and generating a big pose list, make a Boltzmann-weighted choice rather than just getting the lowest energy pose." ).def(false);
...
option.add( basic::options::OptionKeys::stepwise::monte_carlo::exclude_submotifs, "submotifs in database/sampling/rna/submotif/submotifs.txt to exclude" ).def();
...
option.add( basic::options::OptionKeys::stepwise::monte_carlo::designing_with_noncanonicals, "Are we designing with noncanonicals, meaning 'n' has to read from a set of possible symbols (instead of 4 canonical NAs)?" ).def(false);
option.add( basic::options::OptionKeys::stepwise::monte_carlo::checkpointing_frequency, "How often should we output checkpoint files?" ).def(100);
option.add( basic::options::OptionKeys::stepwise::monte_carlo::continue_until_none_missing, "If there are missing residues when we've reached n-cycles, just keep going! Suggested with checkpointing." ).def(false);
option.add( basic::options::OptionKeys::stepwise::monte_carlo::full_model_constraints, "One or more files containing constraints to be applied in a 'full-model' setting, i.e., only in the Modeler and only once residues exist." ).def();
...
option.add( basic::options::OptionKeys::stepwise::monte_carlo::csa::annealing, "Actually anneal the RMSD from the half the average distance between first-bank models to one-fifth that distance" ).def(false);
option.add( basic::options::OptionKeys::stepwise::polar_hydrogens::polar_hydrogens, "polar_hydrogens option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::stepwise::polar_hydrogens::vary_polar_hydrogen_geometry, "Optimize hydrogens that form hydrogen bonds" ).def(false);
option.add( basic::options::OptionKeys::stepwise::polar_hydrogens::bond_angle_sd_polar_hydrogen, "Standard deviation for bond_geometry angle term with -vary_polar_hydrogen_geometry flag, in degrees" ).def(60.0);
option.add( basic::options::OptionKeys::stepwise::polar_hydrogens::bond_torsion_sd_polar_hydrogen, "Standard deviation for bond_geometry torsion term with -vary_polar_hydrogen_geometry flag, in degrees" ).def(30.0);
option.add( basic::options::OptionKeys::stepwise::polar_hydrogens::fix_lengths, "with -vary_geometry, disallow bond length change" ).def(false);
option.add( basic::options::OptionKeys::stepwise::polar_hydrogens::fix_angles, "with -vary_geometry, disallow  bond angle change" ).def(false);
option.add( basic::options::OptionKeys::stepwise::polar_hydrogens::fix_torsions, "with -vary_geometry, disallow bond torsion change beyond standard movemap" ).def(false);
option.add( basic::options::OptionKeys::stepwise::polar_hydrogens::disallow_pack_polar_hydrogens, "with -vary_polar_hydrogen_geometry, disallow polar hydrogen packing step before minimizing" ).def(false);
option.add( basic::options::OptionKeys::stepwise::polar_hydrogens::disallow_vary_geometry_proton_chi, "no packing/minimizing of 2'-OH or other hydrogens controlled by chi torsion" ).def(false);
...
option.add( basic::options::OptionKeys::stepwise::rna::sample_all_chi, "Sample all chi angles (use for blind learning of chi potential)" ).def(false);
...
option.add( basic::options::OptionKeys::full_model::global_seq_file, "File with global sequence and modeled sequence." ).def("");
...
option.add( basic::options::OptionKeys::full_model::twoprime, "twoprime branch points in full model" ).def();
option.add( basic::options::OptionKeys::full_model::fiveprime_cap, "fiveprime capped residues and their corresponding 7MGs" ).def();
...
option.add( basic::options::OptionKeys::full_model::disulfide_res, "optional: residues for defining disulfides -- please supply in pairs" ).def();
...
option.add( basic::options::OptionKeys::trRosetta::trRosetta, "trRosetta option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::trRosetta::msa_file, "Filename for a multiple sequence alignment file, in a3m format.  Dashes indicate gap sequences, and lowercase characters will be removed (and flanking regions ligated)." ).def("");
option.add( basic::options::OptionKeys::trRosetta::write_constraints_to_file, "If provided, trRosetta constraints are written to the specified filename.  No write occurs if not provided or if set to an empty string." ).def("");
option.add( basic::options::OptionKeys::trRosetta::only_write_constraints, "If true, the the trRosettaProtocolMover or trRosetta application skips the structue prediction phase, and ONLY writes constraints to a file.  Must be used in conjunction with a filename specified with the -trRosetta:write_constraints_to_file option.  False by default." ).def(false);
option.add( basic::options::OptionKeys::trRosetta::use_distance_constraints, "Should distance constraints generated by the trRosetta neural network be used during structure prediction?  Default true." ).def(true);
option.add( basic::options::OptionKeys::trRosetta::use_omega_constraints, "Should omega dihedral constraints generated by the trRosetta neural network be used during structure prediction?  Note that this is NOT the backbone omega dihedral angle, but an inter-residue dihedral defined by CA1-CB1-CB2-CA2.  Default true." ).def(true);
option.add( basic::options::OptionKeys::trRosetta::use_theta_constraints, "Should theta dihedral constraints generated by the trRosetta neural network be used during structure prediction?  Note that this is an inter-residue dihedral defined by N1-CA1-CB1-CB2.  Default true." ).def(true);
option.add( basic::options::OptionKeys::trRosetta::use_phi_constraints, "Should phi angle constraints generated by the trRosetta neural network be used during structure prediction?  Note that this is NOT the backbone phi dihedral angle, but an inter-residue angle defined by CA1-CB1-CB2.  Default true." ).def(true);
option.add( basic::options::OptionKeys::trRosetta::distance_constraint_prob_cutoff, "The minimum cumulative probability for residue-pair distance constraints, below which no constraint is added.  Default 0.05." ).def(0.05);
option.add( basic::options::OptionKeys::trRosetta::omega_constraint_prob_cutoff, "The minimum cumulative probability for residue-pair omega dihedral (CA1-CB1-CB2-CA2) constraints, below which no constraint is added.  Default 0.55." ).def(0.55);
option.add( basic::options::OptionKeys::trRosetta::theta_constraint_prob_cutoff, "The minimum cumulative probability for residue-pair theta dihedral (N-CA1-CB1-CB2) constraints, below which no constraint is added.  Default 0.55." ).def(0.55);
option.add( basic::options::OptionKeys::trRosetta::phi_constraint_prob_cutoff, "The minimum cumulative probability for residue-pair phi angle (CA1-CB1-CB2) constraints, below which no constraint is added.  Default 0.65." ).def(0.65);
option.add( basic::options::OptionKeys::trRosetta::backbone_randomization_mode, "The manner in which the polypeptide backbone is initially randomized.  Can be 'classic' (the manner of the original Yang et al. paper), 'ramachandran' (randomizing biased by the Ramachandran preferences of each residue, or 'bins' (randomizing biased by the probability of seeing residue type i in backbone bin X and residue type i+1 in backbone bin Y).  Default 'classic'." ).legal("classic").legal("ramachandran").legal("bins").def("classic");
option.add( basic::options::OptionKeys::trRosetta::backbone_minimization_mode, "The protocol to use for minimizing the backbone given the constraints.  Options are: 'classic0' (minimize using short-range constraints, then minimize using medium-range constraints, then minimize using long-range constraints), 'classic1' (minimize using short- and medium-range constraints, then minimize using long-range constraints), or 'classic2' (minimize using all constraints).  Defaults to 'classic2'." ).legal("classic0").legal("classic1").legal("classic2").def("classic2");
option.add( basic::options::OptionKeys::trRosetta::cis_peptide_prob_non_prepro, "The probability of sampling a cis peptide bond at positions that do not precede proline.  Note that cis omega sampling only happens in 'ramachandran' backbone randomization mode, not in 'classic'.  (In 'bins' mode, the bin transition probabilities govern cis sampling.)  Defaults to 0.0005; must be a value from 0.0 to 1.0." ).def(0.0005);
option.add( basic::options::OptionKeys::trRosetta::cis_peptide_prob_prepro, "The probability of sampling a cis peptide bond at positions that precede proline.  Note that cis omega sampling only happens in 'ramachandran' backbone randomization mode, not in 'classic'.  (In 'bins' mode, the bin transition probabilities govern cis sampling.)  Defaults to 0.05; must be a value from 0.0 to 1.0." ).def(0.05);
option.add( basic::options::OptionKeys::trRosetta::scorefxn0, "Weights file for scorefunction used during initial (stage 0) minimization by the trRosettaProtocol mover.  Defaults to trRosetta_cen0.wts." ).def("trRosetta_cen0.wts");
option.add( basic::options::OptionKeys::trRosetta::scorefxn1, "Weights file for scorefunction used during stage 1 minimization by the trRosettaProtocol mover.  Defaults to trRosetta_cen0.wts." ).def("trRosetta_cen1.wts");
option.add( basic::options::OptionKeys::trRosetta::scorefxn2, "Weights file for scorefunction used during clash relief (stage 2 -- Van der Waals stage) minimization by the trRosettaProtocol mover.  Defaults to trRosetta_cen0.wts." ).def("trRosetta_cen2.wts");
option.add( basic::options::OptionKeys::trRosetta::scorefxn3, "Weights file for scorefunction used during late-stage (stage 3 -- Cartesian stage) minimization by the trRosettaProtocol mover.  Defaults to trRosetta_cen0.wts." ).def("trRosetta_cart.wts");
option.add( basic::options::OptionKeys::trRosetta::scorefxn_fullatom, "Weights file for scorefunction used for fullatom refinement with FastRelax.  If atom-pair_constraint, dihedral_constraint, or angle_constraint terms are zero, they will be set to 5.0, 1.0, and 1.0 respectively.  If empty (the default), then the scoring function specified with -score:weights is used instead." ).def("");
option.add( basic::options::OptionKeys::trRosetta::mutate_gly_to_ala, "If true, glycine residues are mutated to alanine during the centroid phase of minimization, then converted back for fullatom refinement.  True by default to match the original PyRosetta protocol." ).def(true);
option.add( basic::options::OptionKeys::trRosetta::fullatom_refinement, "If true, the structure is converted to a fullatom structure and the FastRelax protocol is run at the end.  The energy function used for this step is the Rosetta default energy function (with atom-pair, dihedral, and angle constraint terms turned on if they are not).  This can be set with the -trRosetta:scorefxn_fullatom flag.  True by default." ).def(true);
option.add( basic::options::OptionKeys::trRosetta::distance_constraint_weight, "A multiplier that can be used to alter the trRosetta distance constraint weights.  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::trRosetta::phi_constraint_weight, "A multiplier that can be used to alter the trRosetta phi (angle) constraint weights.  (Note that phi is the CA1-CB1-CB2 angle, not the usual backbone dihedral angle.)  Default 1.0." ).def(1.0);

}
inline void add_rosetta_options_15( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::trRosetta::omega_constraint_weight, "A multiplier that can be used to alter the trRosetta omega constraint weights.  (Note that omega is the CA1-CB1-CB2-CA2 dihedral angle, not the usual backbone diheral angle.)  Default 1.0." ).def(1.0);
option.add( basic::options::OptionKeys::trRosetta::theta_constraint_weight, "A multiplier that can be used to alter the trRosetta theta constraint weights.  Theta constraints the N1-CA1-CB1-CB2 dihedral.  Default 1.0." ).def(1.0);
...
option.add( basic::options::OptionKeys::ralford::ralford, "ralford option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::ralford::dump_rotamers::dump_rotamers, "dump_rotamers option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::ralford::dump_rotamers::rsd_index, "Dump all of the rotamers for the amino acid at a user-specified position" ).def(1);
option.add( basic::options::OptionKeys::ralford::dump_rotamers::rotamer_info_prefix, "Prefix for output rotamer information file" ).def("output");
option.add( basic::options::OptionKeys::ralford::dump_rotamers::write_rotamers_to_pdbs, "Write all of the rotamer poses to pdb files" ).def(false);
option.add( basic::options::OptionKeys::ralford::dump_rotamers::all_positions, "Option to dump all rotamers at all positions - use with caution" ).def(false);
...
option.add( basic::options::OptionKeys::tcrmodel::tcrmodel, "tcrmodel option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::tcrmodel::ignore_list, "user provided template ignore list for tcrmodel" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::blastp_identity_cutoff, "Cutoff to ignore templates based on blast results" ).def(100);
option.add( basic::options::OptionKeys::tcrmodel::template_identity_cutoff, "Cutoff to ignore templates based on sequence identity score" ).def(100);
option.add( basic::options::OptionKeys::tcrmodel::include_ab_templates, "include antibody templates" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::dump_templates, "dump all template pdb files" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::skip_modeling, "skip the modeling part, used for testing seq and template info" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::ab_template_db_path, "antibody template database path" ).def("./");
option.add( basic::options::OptionKeys::tcrmodel::tcr_template_db_path, "tcr template database path" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::minimize_model, "minimize the tcr model" ).def(true);
option.add( basic::options::OptionKeys::tcrmodel::relax_model, "relax the tcr model" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::remodel_loop_cdr3a, "remodel the cdr3 loop of tcr alpha chain" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::remodel_loop_cdr3b, "remodel the cdr3 loop of tcr beta chain" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::remodel_tcr_cdr3a_loop, "remodel the cdr3 loop of tcr alpha chain" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::remodel_tcr_cdr3b_loop, "remodel the cdr3 loop of tcr beta chain" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::refine_tcr_cdr3a_loop, "refine the cdr3 loop of tcr alpha chain" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::refine_tcr_cdr3b_loop, "refine the cdr3 loop of tcr beta chain" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::remodel_tcr_cdr3_loops, "remodel the cdr3 loop of tcr alpha and beta chains" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::refine_tcr_cdr3_loops, "refine the cdr3 loop of tcr alpha and beta chains" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::refine_all_tcr_cdr_loops, "refine the cdr1, cdr2 and cdr3 loops of tcr alpha and beta chains" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::use_user_templates, "use user provided templates for TCR segments, useful for testing and integrations tests" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::alpha_framework_template_id, "template PDB id with chain for alpha chain framework segment, eg. 1kgc_D" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_framework_template_id, "template PDB id with chain for alpha chain framework segment, eg. 1kgc_E" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_germline_template_id, "template PDB id with chain for alpha chain germline segment, eg. 1kgc_D" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_germline_template_id, "template PDB id with chain for alpha chain germline segment, eg. 1kgc_E" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_cdr1_template_id, "template PDB id with chain for alpha chain CDR1 segment, eg. 1kgc_D" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_cdr1_template_id, "template PDB id with chain for alpha chain CDR1 segment, eg. 1kgc_E" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_cdr2_template_id, "template PDB id with chain for alpha chain CDR2 segment, eg. 1kgc_D" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_cdr2_template_id, "template PDB id with chain for alpha chain CDR2 segment, eg. 1kgc_E" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_cdr3_template_id, "template PDB id with chain for alpha chain CDR3 segment, eg. 1kgc_D" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_cdr3_template_id, "template PDB id with chain for alpha chain CDR3 segment, eg. 1kgc_E" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_orientation_template_id, "template PDB id with chain for orientation of alpha chain, use along with beta_orientation_template_id, eg. 1kgc_D" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_orientation_template_id, "template PDB id with chain for orientation of beta chain, use along with -alpha_orientation_template_id, eg. 1kgc_E" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_framework_template_pdb, "template PDB file for alpha chain framework segment" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_framework_template_pdb, "template PDB file for alpha chain framework segment" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_germline_template_pdb, "template PDB file for alpha chain germline segment" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_germline_template_pdb, "template PDB file alpha chain germline segment" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_cdr1_template_pdb, "template PDB file alpha chain CDR1 segment" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_cdr1_template_pdb, "template PDB file for alpha chain CDR1 segment" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_cdr2_template_pdb, "template PDB file for alpha chain CDR2 segment" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_cdr2_template_pdb, "template PDB file for alpha chain CDR2 segment" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_cdr3_template_pdb, "template PDB file for alpha chain CDR3 segment" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_cdr3_template_pdb, "template PDB file for alpha chain CDR3 segment" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::alpha_orientation_template_pdb, "template PDB file for orientation of alpha chain" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::beta_orientation_template_pdb, "template PDB file for orientation of beta chain" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::use_alpha_germline_templates, "use germline templates for alpha chain, by default germline or framework templates choosen by sequence match" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::use_beta_germline_templates, "use germline templates for beta chain, by default germline or framework templates choosen by sequence match" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::assign_cdr, "assign cdr positions using user provided positions" ).def(false);
option.add( basic::options::OptionKeys::tcrmodel::assign_cdr1a, "assign cdr1a sequence positions by start and end residue numbers, eg. 23:36" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::assign_cdr2a, "assign cdr2a sequence positions by start and end residue numbers, eg. 48:74" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::assign_cdr3a, "assign cdr3a sequence positions by start and end residue numbers, eg. 89:103" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::assign_cdr1b, "assign cdr1b sequence positions by start and end residue numbers, eg. 23:36" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::assign_cdr2b, "assign cdr2b sequence positions by start and end residue numbers, eg. 48:74" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::assign_cdr3b, "assign cdr3b sequence positions by start and end residue numbers, eg. 89:103" ).def("");
option.add( basic::options::OptionKeys::tcrmodel::anarci_path, "path for the program ANARCI to assign CDR positions by aho numbers, eg. '/usr/local/bin/anarci' " ).def("");
...
option.add( basic::options::OptionKeys::PDB_diagnostic::PDB_diagnostic, "PDB_diagnostic option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::PDB_diagnostic::reading_only, "if true, become a no-op (only structure reading is tested). Useful for not-mega-clusters where packing a virus/ribosome will crush memory." ).def(false);
option.add( basic::options::OptionKeys::PDB_diagnostic::skip_pack_and_min, "Skip the packing and minimization steps (leaving in the scoring and ResidueType analyses). Good for speed, or for shallower tests." ).def(false);
...
option.add( basic::options::OptionKeys::testing::INTEGRATION_TEST, "Meta flag for best-practices flags in integration tests. Don't use on actual runs." ).def(false);
option.add( basic::options::OptionKeys::solvent_exposure::solvent_exposure, "solvent_exposure option group" ).legal(true).def(true).is_group(true);
option.add( basic::options::OptionKeys::solvent_exposure::method, "Method to calculate neighbor count, sphere or cone." ).legal("cone").legal("sphere").def("sphere");
